...
public class AdapterConfigTest {
    ...
    public void setUp() throws Exception {
        final Integer westSateCode[] = {10993,12131,12539,28962,13365,17188,28963,18469,19855,20598,22140,23451,28994,11326,12869,28970,14690,15118,16121,28965,17799,29000,20372,21892,22839,28978};        final List<Integer> usaWestStateCodeList = Arrays.asList(westSateCode);
        ...
        expect(mockServerConfig.getUSAWestStatesCodes()).andReturn(usaWestStateCodeList).anyTimes();
    ...
    public Object[][] dataProviderTestUSWestStateHost() {
        ...
        final Integer westSateCode[] = {10993,12131,12539,28962,13365,17188,28963,18469,19855,20598,22140,23451,28994,11326,12869,28970,14690,15118,16121,28965,17799,29000,20372,21892,22839,28978};
    ...
    public Object[][] dataProviderTestUSEastStateHost() {
        final String dcName[] = {"uh1", "lhr1", "hkg1"};
        final Integer eastStateCode[] = {null, 53230,13996,53236,28961,28973,29001,12537,15494,22960,23890,11135,15753,23084,16658,23713,18569,17025,21619,17848,20778,18003,15310,10688,19399,14902,12328,14343,53240};
