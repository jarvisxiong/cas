...
public class RtbNativeAdMakingTest {
    ...
    private static String tangoTemplateContent =
    ...
    private static void setUpRtbAdapter() throws Exception {
        ...
        MemberMatcher.field(RtbAdNetwork.class, "nativeResponseMaker").set(rtbAdNetwork,
    ...
    public void testAppDeserialisationFailure() throws Exception {
        ...
        String adMarkup =
                "{\"version\": \"1.0\",\"iconurl\": \"www.inmobi.com\","
