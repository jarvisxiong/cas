...
# 2) Run: docker run -p 8800:8800 -p 8801:8801 -p 9004:9004 -p 8998:8998 --ulimit nofile=98304:98304 -e IDP_ENVIRONMENT=non_prod -e IDP_CLUSTER=corp -e IDP_NODE=cas1234 --name=cas_container cas_image
# 3) All in one: docker build -t cas_image .; docker rm cas_container; docker run -p 8800:8800 -p 8998:8998 --ulimit nofile=98304:98304 -e IDP_ENVIRONMENT=non_prod -e IDP_CLUSTER=corp -e IDP_NODE=cas1234 --name=cas_container cas_image
...
# docker run -p 8800:8800 -p 8801:8801 -p 9004:9004 -p 8998:8998 --ulimit nofile=98304:98304 -e IDP_ENVIRONMENT=non_prod -e IDP_CLUSTER=corp -e IDP_NODE=test --name=cas dockerhub.corp.inmobi.com/channel_adserve/cas:1681a0affb94
