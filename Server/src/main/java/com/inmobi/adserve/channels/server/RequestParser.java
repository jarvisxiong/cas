...
public class RequestParser {
  ...
  private static String stringify(JSONObject jObject, String field, DebugLogger logger) throws NullPointerException {
    String fieldValue = "";
    try {
  ...
  private static String parseArray(JSONObject jObject, String param, int index) {
    try {
  ...
  private static long[] getCategory(JSONObject jObject, DebugLogger logger) {
    try {
