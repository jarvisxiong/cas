...
public class DcpClientChannelInitializer extends ClientChannelInitializer {
    ...
    @Inject
    DcpClientChannelInitializer(final ServerConfig serverConfig, final LoggingHandler loggingHandler) {
        super(serverConfig, ConnectionType.DCP_OUTGOING, loggingHandler);
    }
