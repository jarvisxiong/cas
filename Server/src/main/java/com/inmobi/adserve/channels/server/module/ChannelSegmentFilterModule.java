...
public class ChannelSegmentFilterModule extends AbstractModule {
        ...
        new ConfigurationBuilder()
            .filterInputsBy(
                new FilterBuilder().includePackage(
                    "com.inmobi.adserve.channels.server.requesthandler.filters.adgroup.impl").includePackage(
  ...
  List<AdvertiserLevelFilter> provideDcpAndRtbdAdvertiserLevelFilters(final Injector injector) {
    ...
    final Set<Class<? extends AdvertiserLevelFilter>> classes = reflections.getSubTypesOf(AdvertiserLevelFilter.class);
