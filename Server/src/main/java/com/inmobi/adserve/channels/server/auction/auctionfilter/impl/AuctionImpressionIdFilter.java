...
public class AuctionImpressionIdFilter extends AbstractAuctionFilter {
    ...
    @Inject
    protected AuctionImpressionIdFilter(Provider<Marker> traceMarkerProvider) {
        super(traceMarkerProvider, InspectorStrings.droppedInRtbImpressionIdMisMatchFilter);
    }
