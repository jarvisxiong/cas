...
public class ChannelServer {
  ...
  public static void main(final String[] args) throws Exception {
    ...
    try {
      ...
      InspectorStats.init(
          configurationLoader.getServerConfiguration().getString("graphiteServer.host", "mon02.ads.uj1.inmobi.com"),
          configurationLoader.getServerConfiguration().getInt("graphiteServer.port", 2003), configurationLoader
      ...
      final Injector injector =
          LifecycleInjector
              .builder()
              .withModules(
                  Modules.combine(new CasNettyModule(configurationLoader.getServerConfiguration()), new ServerModule(
  ...
  private static void instantiateRepository(final Logger logger, final ConfigurationLoader config)
    ...
    try {
      ...
      siteAerospikeFeedbackRepository.init(
          config.getServerConfiguration().subset(ChannelServerStringLiterals.AEROSPIKE_FEEDBACK), getDataCenter());
