...
public class SegmentFactory {
  ...
  public AdNetworkInterface getChannel(final String advertiserId, final String channelId, final Configuration config,
      ...
      final Channel channel, final Set<String> advertiserSet, final boolean isRtbEnabled, final int rtbMaxTimemout,
      ...
      try {
        ...
        final AdNetworkInterface rtbAdNetwork =
            adNetworkInterfaceClass.getConstructor(
                new Class[] {Configuration.class, Bootstrap.class, HttpRequestHandlerBase.class, Channel.class,
                    String.class, String.class, int.class, RepositoryHelper.class, boolean.class}).newInstance(config,
                rtbClientBootstrap, base, channel, adapterConfig.getAdapterHost(), adapterConfig.getAdapterName(),
                rtbMaxTimemout, repositoryHelper, adapterConfig.templateWinNotification());
