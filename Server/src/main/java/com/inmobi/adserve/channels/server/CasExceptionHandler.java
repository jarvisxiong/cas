...
public class CasExceptionHandler extends ChannelInboundHandlerAdapter {
   ...
   * means channel is closed by party who requested for the ad. 2) When timeoutexception occurs, among the partners who
   * gave us the ad, we run the auction from here and return it.
   */
  @Override
