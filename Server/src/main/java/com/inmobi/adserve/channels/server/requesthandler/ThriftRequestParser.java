...
public class ThriftRequestParser {
  ...
  public void parseRequestParameters(final AdPoolRequest tObject, final SASRequestParameters params,
    ...
    if (tObject.isSetSite()) {
      ...
      params.setSiteType(tObject.site.isSetContentRatingDeprecated()
          ? tObject.site.contentRatingDeprecated.toString()
          : "FAMILY_SAFE");
    ...
    if (tObject.isSetGeo()) {
      ...
      params.setPostalCode(null != postalCodes && postalCodes.iterator().hasNext() ? tObject.geo.getZipIds().iterator()
          .next() : null);
