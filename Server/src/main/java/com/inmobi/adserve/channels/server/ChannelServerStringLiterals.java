...
public final class ChannelServerStringLiterals {
    ...
    public static final String CHANNEL_SEGMENT_FEEDBACK_REPOSITORY = "ChannelSegmentFeedbackRepository";
    ...
    public static final String DEALS_PACKAGES_MAPPING_REPOSITORY = "dealsPackagesMappingRepository";
