...
public class ThriftRequestMaker {
    ...
    private static String getImpressionId() {
        ...
        final String uuidMachineKey = WilburyUUID.setMachineId(uuidIntKey, (short) 2003).toString();
        final String uuidWithCyclicCounter =
                WilburyUUID.setCyclicCounter(uuidMachineKey, (byte) atomicInteger.getAndIncrement()).toString();
    ...
    public static void main(final String[] args) throws Exception {
        ...
        */
        ...
        final AdPoolRequest adPoolRequest = createAdPoolRequest();
    ...
    private static AdPoolRequest createAdPoolRequest() {
        ...
        final Set<Integer> zips = new HashSet<Integer>();
        zips.add(1);
        geo.setZipIds(zips);
    ...
    private static void sendBackFillGet(final AdPoolRequest adPoolRequest) throws Exception {
        ...
        final byte[] requestContent = serializer.serialize(adPoolRequest);
        final URLCodec urlCodec = new URLCodec();
        final String content = new String(urlCodec.encode(urlCodec.encode(requestContent)));
        // request.addHeader("adPoolRequest", content);
        url = url + content;
        final AdPoolRequest adPoolRequest1 = new AdPoolRequest();
        final TDeserializer tDeserializer = new TDeserializer(new TBinaryProtocol.Factory());
        try {
    ...
    private static void sendUMPPost(final AdPoolRequest adPoolRequest) throws Exception {
        ...
        final String targetUrl = "http://localhost:8800/rtbdFill";
        final TSerializer serializer = new TSerializer(new TBinaryProtocol.Factory());
