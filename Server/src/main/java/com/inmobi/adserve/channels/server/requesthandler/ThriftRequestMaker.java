...
public class ThriftRequestMaker {
	...
	public static void main(final String[] args) throws Exception {
		/*
		 * Integer adIncId =
		 * WilburyUUID.getIntKey("227ee495-0146-1000-2251-e49510070000");
	...
	private static void sendBackFillGet(final AdPoolRequest adPoolRequest) throws Exception {
		...
		String url = "http://localhost:8800/rtbdFill?adPoolRequest=";
		...
		String tempContent = new String(urlCodec.encode(requestContent));
		// request.addHeader("adPoolRequest", content);
		System.out.println(urlCodec.encode(requestContent));
		url = url + content;
		// AdPoolRequest adPoolRequest1 = new AdPoolRequest();
		// TDeserializer tDeserializer = new TDeserializer(new
		// TBinaryProtocol.Factory());
		// try {
		// tDeserializer.deserialize(adPoolRequest1,
		// urlCodec.decode(content.getBytes()));
		// } catch (TException ex) {
		// ex.printStackTrace();
		// }
