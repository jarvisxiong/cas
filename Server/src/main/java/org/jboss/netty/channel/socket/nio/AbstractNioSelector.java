...
abstract class AbstractNioSelector implements NioSelector {
    ...
    private void setPrefix(Executor executor) {
    	prefix = "";
    	if(executor instanceof ThreadPoolExecutor){
    		ThreadPoolExecutor threadPoolExecutor = (ThreadPoolExecutor)executor; 
    		
    		if(threadPoolExecutor.getThreadFactory() instanceof DefaultThreadFactory){
    			DefaultThreadFactory defaultThreadFactory = (DefaultThreadFactory)threadPoolExecutor.getThreadFactory();
    			
    			this.prefix = defaultThreadFactory.getPrefix();
    		}
    	}
	}
