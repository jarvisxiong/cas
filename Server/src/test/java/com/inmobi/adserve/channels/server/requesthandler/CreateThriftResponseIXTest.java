...
public class CreateThriftResponseIXTest {
    ...
    public void setUp() {
        ...
        dummyChannelSegmentEntity = new ChannelSegmentEntity(
                ChannelSegmentFilterApplierTest.getChannelSegmentEntityBuilder("Advertiser A", "adgroupId", "adId", "channelId",
                        1, null, null, true, true, "externalSiteKey", null, "campaignId", null, 1, true,
                        "pricingModel", null, 1, null, false, false, false, false, false, false, false, false,
    ...
    public void testCreateThriftResponse() {
        ...
        Assert.assertEquals(ixAd.getImpressionId(), new GUID(uuid.getMostSignificantBits(), uuid.getLeastSignificantBits()));
        Assert.assertEquals(ixAd.getSlotServed(), 0);

        Creative ixCreative = new Creative();
