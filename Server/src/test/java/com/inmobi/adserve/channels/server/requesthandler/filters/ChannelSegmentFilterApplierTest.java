...
public class ChannelSegmentFilterApplierTest extends TestCase {
  ...
  public void setUp() throws Exception {
    ...
    cFE1 =
        new ChannelFeedbackEntity(getChannelFeedbackEntityBuilder(advertiserId1, 100.0, 50.0, 50.0, 100, 95, 120, 1.0,
            4.0));
    cFE2 =
        new ChannelFeedbackEntity(getChannelFeedbackEntityBuilder(advertiserId2, 100.0, 95.0, 5.0, 100, 55, 120, 2.0,
            0.6));
    cFE3 =
        new ChannelFeedbackEntity(getChannelFeedbackEntityBuilder(advertiserId2, 100.0, 50.0, 50.0, 100, 55, 0, 1.0,
            4.0));
    cSFE1 =
        new ChannelSegmentFeedbackEntity(getChannelSegmentFeedbackBuilder(advertiserId1, "adgroupId1", 0.29, 0.1, 0, 0,
            0, 0, 200));
    cSFE2 =
        new ChannelSegmentFeedbackEntity(getChannelSegmentFeedbackBuilder(advertiserId1, "adgroupId2", 0.9, 0.1, 0, 0,
            0, 0, 0));
    cSFE3 =
        new ChannelSegmentFeedbackEntity(getChannelSegmentFeedbackBuilder(advertiserId1, "adgroupId3", 0.4, 0.1, 0, 0,
            0, 0, 0));
    cSFE4 =
        new ChannelSegmentFeedbackEntity(getChannelSegmentFeedbackBuilder(advertiserId2, "adgroupId4", 0.2, 0.1, 0, 0,
            0, 0, 50));
    cSFE5 =
        new ChannelSegmentFeedbackEntity(getChannelSegmentFeedbackBuilder(advertiserId2, "adgroupId5", 0.5, 0.1, 0, 0,
            0, 0, 0));
    cSFE6 =
        new ChannelSegmentFeedbackEntity(getChannelSegmentFeedbackBuilder(advertiserId3, "adgroupId6", 0.7, 0.1, 0, 0,
            0, 0, 0));
    ...
    channelSegmentEntity1 =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(advertiserId1, "adgroupId1", "adId", "channelId1", 1,
            rcList, tags, true, true, "externalSiteKey", modified_on, "campaignId", slotIds, 1, true, "pricingModel",
            siteRatings, 1, null, false, false, false, false, false, false, false, false, false, false, null,
            new ArrayList<Integer>(), 0.0d, null, null, true, emptySet, 100));
    channelSegmentEntity2 =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(advertiserId1, "adgroupId2", "adId", "channelId1", 0,
            rcList, tags, false, true, "externalSiteKey", modified_on, "campaignId", slotIds, 1, true, "pricingModel",
            siteRatings, 1, null, false, false, false, false, false, false, false, false, false, false, null,
            new ArrayList<Integer>(), 0.0d, null, null, false, emptySet, 0));
    channelSegmentEntity3 =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(advertiserId1, "adgroupId3", "adId", "channelId1", 1,
            rcList, tags, false, false, "externalSiteKey", modified_on, "campaignId", slotIds, 0, false,
    ...
    channelSegmentEntity4 =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(advertiserId2, "adgroupId4", "adId", "channelId2", 1,
            rcList, tags, true, true, "externalSiteKey", modified_on, "campaignId", slotIds, 1, true, "pricingModel",
            siteRatings, 1, null, false, false, false, false, false, false, false, false, false, false, null,
            new ArrayList<Integer>(), 0.0d, null, null, false, emptySet, 100));
    channelSegmentEntity5 =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(advertiserId2, "adgroupId5", "adId", "channelId2", 1,
            rcList, tags, true, true, "externalSiteKey", modified_on, "campaignId", slotIds, 1, true, "pricingModel",
            siteRatings, 1, null, false, false, false, false, false, false, false, false, false, false, null,
            new ArrayList<Integer>(), 0.0d, null, null, false, emptySet, 0));
    channelSegmentEntity6 =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(advertiserId3, "adgroupId5", "adId", "channelId3", 1,
            rcList, tags, true, true, "externalSiteKey", modified_on, "campaignId", slotIds, 1, true, "pricingModel",
            siteRatings, 1, null, false, false, false, false, false, false, false, false, false, false, null,
            new ArrayList<Integer>(), 0.0d, null, null, false, emptySet, 0));
    ...
    channelSegment1 =
        new ChannelSegment(channelSegmentEntity1, cE1, cFE1, cSFE1, channelSegmentFeedbackEntity, null, cSFE1.getECPM());
    channelSegment2 =
        new ChannelSegment(channelSegmentEntity2, cE1, cFE1, cSFE2, channelSegmentFeedbackEntity, null, cSFE2.getECPM());
    channelSegment3 =
        new ChannelSegment(channelSegmentEntity3, cE1, cFE1, cSFE3, channelSegmentFeedbackEntity, null, cSFE3.getECPM());
    channelSegment4 =
        new ChannelSegment(channelSegmentEntity4, cE2, cFE2, cSFE4, channelSegmentFeedbackEntity, null, cSFE4.getECPM());
    channelSegment5 =
        new ChannelSegment(channelSegmentEntity5, cE2, cFE2, cSFE5, channelSegmentFeedbackEntity, null, cSFE5.getECPM());
    channelSegment6 =
        new ChannelSegment(channelSegmentEntity6, cE3, cFE3, cSFE6, channelSegmentFeedbackEntity, null, cSFE6.getECPM());
  ...
  public void testIsBurnLimitExceeded() {
    ...
    final List<ChannelSegment> channelSegments =
        channelSegmentFilterApplier.getChannelSegments(advertiserMatchedSegmentDetails, sasParams, new CasContext(),
            dcpAndRtbdAdvertiserLevelFilters, dcpAndRtbAdGroupLevelFilters);
  ...
  public void testAdvertiserLevelFilter() {
    ...
    assertEquals(false,
        channelSegmentList.get(0).getChannelEntity().getAccountId().equals(channelSegmentEntity6.getAdvertiserId()));
  }
  ...
  public void testIsSiteExcludedByAdGroupInclusionTrueEmptyList() {
    ...
    final AdGroupSiteExclusionFilter adGroupTotalCountFilter = injector.getInstance(AdGroupSiteExclusionFilter.class);
    adGroupTotalCountFilter.filter(channelSegments, sasParams, new CasContext());
  ...
  public void testIsAdGroupDailyImpressionCeilingExceeded() {
    ...
    final List<ChannelSegment> channelSegments = Lists.newArrayList(channelSegment1, channelSegment4, channelSegment6);
