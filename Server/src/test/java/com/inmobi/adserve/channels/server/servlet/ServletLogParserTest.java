...
public class ServletLogParserTest {
  ...
  public void testHandleRequestHttpMethodIsPostExitStatusIs0() throws Exception {
    ...
    expectNew(ProcessBuilder.class, CasConfigUtil.getServerConfig().getString("logParserScript"), "-t", targetStrings,
        "-l", logFilePath).andReturn(mockProcessBuilder).times(1);
    replayAll();
