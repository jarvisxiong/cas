...
public class AuctionEngineTest {
	...
	private ChannelSegment setBidder(final String advId,
			final String channelId, final String externalSiteKey,
			final String adNetworkName, final Double bidValue,
			final Long latencyValue) {
	...
	public Object[][] paramDataProviderWith3Bidders() {
		return new Object[][]{
				...
				{ "testTwoSameBidsHigherThanFloorPrice", .70d, "A", 1d, 120l, "B", .80d, 100l, "C", .80d, 150l, .81d, "A", 1d},
				
				// 10. 2 same second bids, with same latency, higher than floor price
				{ "testTwoSameSecondBidsWithSameLatencyHigherThanFloorPrice",.70d, "A", 1d, 120l, "B", .80d, 100l, "C", .80d, 100l, .81d, "A", 1d},
				
				// 11. 2 same second bids, lower than floor price
				{ "testTwoSameSecondBidsLowerThanFloorPrice", .70d, "A", 1d, 120l, "B", .60d, 100l, "C", .60d, 150l, .71d, "A", 1d},
				
				// 12. 2 same second bids, lower than 90% of Highest bid but more than floor price
				{ "testTwoSameSecondBidsLowerThan90PercentOfHighestBidButMoreThanFloorPrice", .70d, "A", 1d, 120l, "B", .85d, 100l, "C", .85d, 150l,
						.86d, "A", 1d},
				
				// 13. 2 same second bids, lower than 90% of Highest bid and lower than floor price
				{ "testTwoSameSecondBidsLowerThan90PercentOfHighestBidAndLowerThanFloorPrice", .70d, "A", 1d, 120l, "B", .65d, 100l, "C", .65d, 150l,
						.71d, "A", 1d},
				
				// 14. 2 same second bids, higher than 90% of Highest bid but more than floor price
				{ "testTwoSameSecondBidsHigherThan90PercentOfHighestBidButMoreThanFloorPrice", .70d, "A", 1d, 120l, "B", .95d, 100l, "C", .95d, 150l,
						.96d, "A", 1d},
				
				// 15. 2 same second bids, higher than 90% of Highest bid and lower than floor price
				{"testTwoSameSecondBidsHigherThan90PercentOfHighestBidButLowerThanFloorPrice", .98d, "A", 1d, 120l, "B", .95d, 100l, "C", .95d, 150l,
						.99d, "A", 1d},
				
				// 18. First and Second bid with .01 difference. He will be charged same Bid he auctioned
				{ "testFirstAndSecondBidWith01difference", .70d, "A", 1d, 100l, "B", .99d, 100l, "C", .70d, 100l, 1d, "A", 1d},
				
				// 19. 2nd price same as floor price
				{ "testSecondPriceSameAsFloorPrice", .70d, "A", 1d, 100l, "B", .70d, 100l, "C", .70d, 100l, .71d, "A", 1d},
				
				// 20. 2nd price same as floor price and 90% price
				{ "testSecondPriceSameAsFloorPriceAnd90PercentPrice", .90d, "A", 1d, 100l, "B", .90d, 100l, "C", .70d, 100l, .91d, "A", 1d}
	...
	public void testAuctionEngineWith3BiddersExample(final String useCaseName, final Double floorPrice, 
			final String rtbNameInput1, final Double bidInput1, final Long latencyInput1,
			final String rtbNameInput2, final Double bidInput2, final Long latencyInput2, 
			final String rtbNameInput3, final Double bidInput3, final Long latencyInput3,
		...
		rtbSegments.add(setBidder("advId1", "channelId1", "externalSiteKey1", rtbNameInput1, bidInputVal1, latencyInputVal1));
		rtbSegments.add(setBidder("advId2", "channelId2", "externalSiteKey2", rtbNameInput2, bidInputVal2, latencyInputVal2));
		rtbSegments.add(setBidder("advId3", "channelId3", "externalSiteKey3", rtbNameInput3, bidInputVal3, latencyInputVal3));
	...
	public Object[][] paramDataProviderWith4Bidders() {
		return new Object[][]{
				...
				{"testBidHigherThanFloorPriceAndSecondPrice", .70d, "A", 1d, 50l, "B", .90d, 100l, "C", .80d, 150l, "D", .70d, 100l,
						.91d, "A", 1d},
				
				// 2. same first bid price
				{"testSameFirstBidPrice", .70d, "A", 1d, 100l, "B", 1d, 75l, "C", 1d, 50l, "D", .70d, 100l, .71d, "C", 1d},
				
				// 3. same second bid price
				{"testSameSecondBidPrice", .70d, "A", 1d, 100l, "B", .80d, 50l, "C", .80d, 150l, "D", .70d, 100l, .81d, "A", 1d},

				// 4. 2 win bid with same latency
				{"testTwoWinBidsWithSameLantency", .70d, "A", 1d, 100l, "B", 1d, 100l, "C", .80d, 150l, "D", .70d, 100l, .81d, "A",
						1d},
				
				// 6. lower than floor price, the second bid onwards
				{"testBidLowerThanFloorPriceFromSecondBidOnwards", .70d, "A", 1d, 100l, "B", .40d, 100l, "C", .20d, 150l, "D", .45d,
						100l, .71d, "A", 1d},
				
				// 8. all same bids, then latency is considered
				{"testAllSameBidsWithDifferentLatency", .70d, "A", 1d, 120l, "B", 1d, 100l, "C", 1d, 150l, "D", 1d, 70l, .71d, "D",
						1d},
				
				// 16. 2 same first bid with 2nd Highest bid with 0.01 difference
				{"testTwoSameFirstBidWithSecondHighestBidWith01difference", .70d, "A", 1d, 100l, "B", 1d, 100l, "C", .99d, 150l,
						"D", .70d, 100l, 1d, "A", 1d},
				
				// 17. First and Second bid with .01 difference and double 2nd entry. He will charged sameBid he
				// auctioned
				{"testFirstAndSecondBidWith01differenceAndDoubleSecondEntry", .70d, "A", 1d, 100l, "B", .99d, 100l, "C", .99d, 150l,
						"D", .70, 100l, 1d, "A", 1d},
				
				// 21. 2 Highest price, and 2 same Second price
				{"testSecondHighestPriceAndTwoSameSecondPrice", .70d, "A", 1d, 100l, "B", 1d, 100l, "C", .90d, 150l, "D", .90d, 100l,
						.91d, "A", 1d},
				
				// 22. 2 Highest price, and 2 same Second price, lower than floor price
				{ "testTwoSecondHighestPriceAndTwoSameSecondPriceButLowerThanFloorPrice", .70d, "A", 1d, 100l, "B", 1d, 100l, "C", .60d, 150l,
						"D", .60d, 100l, .71d, "A", 1d},
				
				// 23. 2nd price is 0.1 above floor price
				{"testSecondPriceIs1AboveFloorPrice", .70d, "A", .71d, 100l, "B", 1d, 100l, "C", .60d, 150l, "D", .60d, 100l, .72d,
						"B", 1d},
				
				// 24. 2nd price is 0.1 below floor price. this bid will get directly cut off at floor price filter
				{"testSecondPriceIs1BelowFloorPrice", .70d, "A", 1d, 100l, "B", .69d, 100l, "C", .60d, 150l, "D", .60d, 100l, .71d,
						"A", 1d}
	...
	public void testAuctionEngineWith4BiddersExample(final String useCaseName, final Double floorPrice, 
			...
			final String rtbNameInput2, final Double bidInput2, final Long latencyInput2, 
			final String rtbNameInput3, final Double bidInput3, final Long latencyInput3, 
			final String rtbNameInput4, final Double bidInput4, final Long latencyInput4, 
			final Double expectedSecondPriceValue, final String expectedRTBName, final Double expectedWinnerBidValue) {
		...
		rtbSegments.add(setBidder("advId2", "channelId2", "externalSiteKey2", rtbNameInput2, bidInputVal2, latencyInputVal2));
		rtbSegments.add(setBidder("advId3", "channelId3", "externalSiteKey3", rtbNameInput3, bidInputVal3, latencyInputVal3));
		rtbSegments.add(setBidder("advId4", "channelId4", "externalSiteKey4", rtbNameInput4, bidInputVal4, latencyInputVal4));
		auctionEngine.setRtbSegments(rtbSegments);
	...
	public void testAllLowerThanFloorPrice() {
		...
		Assert.assertEquals(auctionEngineResponse,
				expectedAuctionEngineResponse);
	}
