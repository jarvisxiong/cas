...
public class AuctionEngineTest
{
            ...
            final String adNetworkName, final Double bidValue, final Long latencyValue)
    {
        ...
        ChannelSegmentEntity channelSegmentEntity1 = new ChannelSegmentEntity(advId, "adgroupId", "adId", channelId, 1,
    ...
    @Test
    // 26. Only 1 bid with price 0.1 below floor price. this bid will get directly cut off at floor price filter
