...
public class ServletRepoRefreshTest {
  ...
  private static void prepareMockConfigurationLoader() {
    ...
    expect(mockServerConfig.subset(ChannelServerStringLiterals.CHANNEL_ADGROUP_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
    expect(mockServerConfig.subset(ChannelServerStringLiterals.CHANNEL_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
    expect(mockServerConfig.subset(ChannelServerStringLiterals.CHANNEL_FEEDBACK_REPOSITORY))
    ...
    expect(mockServerConfig.subset(ChannelServerStringLiterals.SITE_METADATA_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
    expect(mockServerConfig.subset(ChannelServerStringLiterals.SITE_TAXONOMY_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
    expect(mockServerConfig.subset(ChannelServerStringLiterals.PRICING_ENGINE_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
    ...
    expect(mockServerConfig.subset(ChannelServerStringLiterals.CURRENCY_CONVERSION_REPOSITORY)).andReturn(
        mockServerConfig).anyTimes();
    expect(mockServerConfig.subset(ChannelServerStringLiterals.WAP_SITE_UAC_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
    expect(mockServerConfig.subset(ChannelServerStringLiterals.IX_ACCOUNT_MAP_REPOSITORY)).andReturn(mockServerConfig)
        .anyTimes();
  ...
  private static void prepareMockCasConfigUtil() throws RepositoryException {
    ...
    expect(mockRepositoryHelper.getChannelSegmentFeedbackRepository()).andReturn(mockChannelSegmentFeedbackRepository)
        .anyTimes();
