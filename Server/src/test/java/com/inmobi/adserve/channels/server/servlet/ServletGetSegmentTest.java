...
public class ServletGetSegmentTest {
    ...
    public void testHandleRequestJsonObjectIsNotNull() throws Exception {
        ...
        expect(mockJSONObject.getString("repo-name")).andReturn(ChannelServerStringLiterals.CHANNEL_REPOSITORY)
                .times(1).andReturn(ChannelServerStringLiterals.CHANNEL_ADGROUP_REPOSITORY).times(1)
        ...
        expect(mockRepositoryHelper.queryChannelSegmentFeedbackRepository(id)).andReturn(
                mockChannelSegmentFeedbackEntity).times(1);
        ...
        expect(
                mockRepositoryHelper.queryPricingEngineRepository(Integer.parseInt(id.split("_")[0]),
        ...
        expect(
                mockRepositoryHelper.querySiteAerospikeFeedbackRepository(id.split("_")[0],
                        Integer.parseInt(id.split("_")[1]))).andReturn(mockSegmentAdGroupFeedbackEntity).times(1);
        expect(mockRepositoryHelper.querySiteAerospikeFeedbackRepository(id2)).andReturn(mockSiteFeedbackEntity).times(
                1);
        expect(
                mockRepositoryHelper.querySiteEcpmRepository(id.split("_")[0], Integer.parseInt(id.split("_")[1]),
        ...
        expect(mockRepositoryHelper.queryCurrencyConversionRepository(id)).andReturn(mockCurrencyConversionEntity)
                .times(1);
        expect(mockRepositoryHelper.queryWapSiteUACRepository(id.split("_")[0])).andReturn(mockWapSiteUACEntity).times(
                1);
        expect(mockRepositoryHelper.queryIXAccountMapRepository(Long.parseLong(id.split("_")[0]))).andReturn(
                mockIXAccountMapEntity).times(1);
        expect(mockRepositoryHelper.queryCreativeRepository(id.split("_")[0], id.split("_")[1])).andReturn(
                mockCreativeEntity).times(1);

        mockResponseSender
                .sendResponse(
                        "{\"0_1_2_SiteFilterRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"isExpired\":false},\"0_1_2_CurrencyConversionRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}}},\"0_1_2_IXAccountMapRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}}},\"0_1_2_aerospike\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}}},\"0_1_2_ChannelRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"isActive\":false,\"isTestMode\":false,\"burstQps\":0,\"impressionCeil\":0,\"impressionFloor\":0,\"requestCap\":0,\"priority\":0,\"demandSourceTypeId\":0,\"isRtb\":false,\"wnRequied\":false,\"wnFromClient\":false,\"isSiteInclusion\":false,\"accountSegment\":0},\"0_1_2_ChannelFeedbackRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"totalInflow\":0.0,\"totalBurn\":0.0,\"balance\":0.0,\"totalImpressions\":0,\"todayRequests\":0,\"todayImpressions\":0,\"averageLatency\":0,\"revenue\":0.0},\"0_1_2_ChannelAdGroupRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"platformTargeting\":0,\"status\":false,\"isTestMode\":false,\"adgroupIncId\":0,\"allTags\":false,\"udIdRequired\":false,\"zipCodeRequired\":false,\"latlongRequired\":false,\"restrictedToRichMediaOnly\":false,\"appUrlEnabled\":false,\"interstitialOnly\":false,\"nonInterstitialOnly\":false,\"stripUdId\":false,\"stripZipCode\":false,\"stripLatlong\":false,\"isSiteInclusion\":false,\"impressionCeil\":0,\"ecpmBoost\":0.0,\"dst\":0,\"campaignIncId\":0},\"0_1_2_ChannelSegmentFeedbackRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"eCPM\":0.0,\"fillRatio\":0.0,\"lastHourLatency\":0.0,\"todayRequests\":0,\"beacons\":0,\"clicks\":0,\"todayImpressions\":0},\"0_1_2_PricingEngineRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"rtbFloor\":0.0,\"dcpFloor\":0.0},\"0_aerospike\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"lastUpdated\":0},\"0_1_2_WapSiteUACRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"siteTypeId\":0,\"isCoppaEnabled\":false,\"isTransparencyEnabled\":false},\"0_1_2_CreativeRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}}},\"0_1_2_SiteTaxonomyRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}}},\"0_1_2_SiteEcpmRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}},\"ecpm\":0.0,\"networkEcpm\":0.0},\"0_1_2_SiteMetaDataRepository\":{\"CGLIB$BOUND\":true,\"CGLIB$CALLBACK_0\":{\"handler\":{\"delegate\":{\"control\":{\"state\":{\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"lock\":{\"sync\":{\"state\":0}}},\"behavior\":{\"behaviorLists\":[],\"stubResults\":[],\"nice\":false,\"checkOrder\":false,\"isThreadSafe\":true,\"shouldBeUsedInOneThread\":false,\"position\":0},\"type\":\"DEFAULT\"}}}}}}",
                        null);
        expectLastCall().times(1);
