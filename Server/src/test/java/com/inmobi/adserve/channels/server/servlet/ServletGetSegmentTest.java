...
public class ServletGetSegmentTest {
  ...
  public void testHandleRequestJsonObjectIsNotNull() throws Exception {
    ...
    expect(mockRepositoryHelper.queryChannelSegmentFeedbackRepository(id)).andReturn(mockChannelSegmentFeedbackEntity)
        .times(1);
    ...
    expect(
        mockRepositoryHelper.querySiteAerospikeFeedbackRepository(id.split("_")[0], Integer.parseInt(id.split("_")[1])))
        .andReturn(mockSegmentAdGroupFeedbackEntity).times(1);
    expect(mockRepositoryHelper.querySiteAerospikeFeedbackRepository(id2)).andReturn(mockSiteFeedbackEntity).times(1);
    expect(
    ...
    expect(mockRepositoryHelper.queryCurrencyConversionRepository(id)).andReturn(mockCurrencyConversionEntity).times(1);
    expect(mockRepositoryHelper.queryWapSiteUACRepository(id.split("_")[0])).andReturn(mockWapSiteUACEntity).times(1);
