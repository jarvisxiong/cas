...
public class LoggingTest extends TestCase {
  ...
  public void setUp() {
    ...
    replay(mockConfig);
    final AbstractMessagePublisher dataBusPublisher = createMock(AbstractMessagePublisher.class);
  ...
  public void testsampledAdvertisingLogging() {
    ...
    final ChannelSegmentEntity channelSegmentEntity =
        new ChannelSegmentEntity(ChannelSegmentFilterApplierTest.getChannelSegmentEntityBuilder("advertiserId",
            ...
            "campaignId", slotIds, 1, true, "pricingModel", siteRatings, 1, null, false, false, false, false, false,
            false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null, null, false, emptySet, 0));
