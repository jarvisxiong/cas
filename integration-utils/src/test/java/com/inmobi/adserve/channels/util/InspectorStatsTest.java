...
public class InspectorStatsTest {
    ...
    public void testInit() throws Exception {
        ...
        expect(mockConfig.getString("graphiteServer.host", "cas-metrics-relay.uj1.inmobi.com")).andReturn(
        ...
        GraphiteReporter.enable(isA(MetricsRegistry.class), eq((long) graphiteInterval), eq(TimeUnit.MINUTES),
                eq(graphiteServer), eq(graphitePort), eq(expectedMetricProducer));
