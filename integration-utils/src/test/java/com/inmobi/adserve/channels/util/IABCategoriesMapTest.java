...
public class IABCategoriesMapTest {
    ...
    public void testGetIABCategories() throws Exception {
        Long category = IABCategoriesMap.FAMILY_SAFE_BLOCK_CATEGORIES;
        List<String> expected = new ArrayList<>(Arrays.asList(new String[]{ "IAB11", "IAB11-1", "IAB11-2",
    ...
    public void testGetIABCategoriesSet() throws Exception {
        List<Long> category = Arrays.asList(IABCategoriesMap.FAMILY_SAFE_BLOCK_CATEGORIES, IABCategoriesMap.PERFORMANCE_BLOCK_CATEGORIES);
        IABCategoriesMap tested = new IABCategoriesMap();
        ...
        List<String> expected = new ArrayList(iabCategoriesSet);
