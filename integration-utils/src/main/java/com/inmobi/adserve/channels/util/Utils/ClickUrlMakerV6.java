...
public class ClickUrlMakerV6 {
     ...
     */
    public static class ClickUrlsRegenerator {
        ...
        public static void init(String cryptoSecretKey, String testCryptoSecretKey, String rmBeaconURLPrefix,
                                String imageBeaconURLPrefix, String clickURLPrefix, Boolean isRmAd, Boolean testMode,
            ...
            ClickUrlsRegenerator.isRmAd                = isRmAd;
        ...
        public static String regenerateBeaconUrl(String beaconUrl, String oldImpressionId, String newImpressionId) {
