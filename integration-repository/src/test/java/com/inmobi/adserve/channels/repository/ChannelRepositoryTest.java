...
public class ChannelRepositoryTest {
    ...
    public void testBuildObjectFromRowRequestCapIs0SiteInclusionIsTrue() throws Exception {
        String sieJson = "{\"sites\":[\"abcd\",\"efgh\"],\"mode\":\"inclusion\"}";
        Set<String> siteIE = new HashSet(Arrays.asList("abcd", "efgh"));

        String id = "id";
        Timestamp modifiedOn = new Timestamp(1234L);
        String name = "name";
        String accountId = "account_id";
        String reportingApiKey = "reporting_api_key";
        String reportingApiUrl = "reporting_api_url";
        String username = "username";
        String password = "password";
        Boolean isTestMode = false;
        Boolean isActive= true;
        Long burstQps = 500L;
        Long impressionCeil = 1000L;
        Long impressionFloor = 100L;
        Long requestCap = 0L;
        int priority = 5;
        int demandSourceTypeId = 8;
        int accountSegment = 1;
        ...
        ChannelRepository tested = new ChannelRepository();
        DBEntity<ChannelEntity, String> entity = tested.buildObjectFromRow(null);
        ChannelEntity output = entity.getObject();
    ...
    public void getModeTest() throws Exception {
        String workingSieJsonTrue = "{\"sites\":[\"abcd\",\"efgh\"],\"mode\":\"inclusion\"}";
        String workingSieJsonFalse = "{\"sites\":[\"abcd\",\"efgh\"],\"mode\":\"exclusion\"}";
        String faultySieJson = "NotAJson";
    ...
    public void getSitesTest() throws Exception {
        String workingSieJson = "{\"sites\":[\"abcd\",\"efgh\"],\"mode\":\"inclusion\"}";
        String faultySieJson = "NotAJson";
        Set<String> output = new HashSet<String>(Arrays.asList("abcd", "efgh"));
        Set<String> emptyOutput = new HashSet<String>();
    ...
    public void testIsObjectToBeDeleted() throws Exception {
        ChannelRepository tested = new ChannelRepository();
        ChannelEntity dummy = createMock(ChannelEntity.class);

        expect(dummy.getId())
                .andReturn(null).times(1)
                .andReturn("Id").times(1);
        replayAll();
