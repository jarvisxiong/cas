...
public class RepositoryHelperTest {
  ...
  public static void setUp() throws Exception {
    ...
    expect(mockChannelSegmentFeedbackRepository.query(query1))
        .andThrow(new RepositoryException("Repository Exception")).times(1).andReturn(mockChannelSegmentFeedbackEntity)
        .times(1);
    expect(mockSiteMetaDataRepository.query(query1)).andThrow(new RepositoryException("Repository Exception")).times(1)
        .andReturn(mockSiteMetaDataEntity).times(1);
    expect(mockSiteTaxonomyRepository.query(query1)).andThrow(new RepositoryException("Repository Exception")).times(1)
    ...
    expect(mockPricingEngineRepository.query(mockPricingEngineQuery))
        .andThrow(new RepositoryException("Repository Exception")).times(1).andReturn(mockPricingEngineEntity).times(1);
    expect(mockSiteFilterRepository.query(mockSiteFilterQuery))
        .andThrow(new RepositoryException("Repository Exception")).times(1).andReturn(mockSiteFilterEntity).times(1);
    expect(mockSiteEcpmRepository.query(mockSiteEcpmQuery)).andThrow(new RepositoryException("Repository Exception"))
        .times(1).andReturn(mockSiteEcpmEntity).times(1);
    ...
    expect(mockWapSiteUACRepository.query(query1)).andThrow(new RepositoryException("Repository Exception")).times(1)
        .andReturn(mockWapSiteUACEntity).times(1);
    expect(mockIxAccountMapRepository.query(query4)).andThrow(new RepositoryException("Repository Exception")).times(1)
        .andReturn(mockIxAccountMapEntity).times(1);
    expect(mockCreativeRepository.query(mockCreativeQuery)).andThrow(new RepositoryException("Repository Exception"))
        .times(1).andReturn(mockCreativeEntity).times(1);
