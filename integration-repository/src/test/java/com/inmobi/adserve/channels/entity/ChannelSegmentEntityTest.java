...
public class ChannelSegmentEntityTest {
  ...
  public ChannelSegmentEntity.Builder getChannelSegmentEntityBuilder(final String advertiserId, final String adgroupId,
      final String[] adIds, final String channelId, final long platformTargeting, final Long[] rcList,
      final Long[] tags, final boolean status, final boolean isTestMode, final String externalSiteKey,
      final Timestamp modified_on, final String campaignId, final Long[] slotIds, final Long[] incIds,
      final boolean allTags, final String pricingModel, final Integer[] siteRatings, final int targetingPlatform,
      final ArrayList<Integer> osIds, final boolean udIdRequired, final boolean zipCodeRequired,
      final boolean latlongRequired, final boolean richMediaOnly, final boolean appUrlEnabled,
      final boolean interstitialOnly, final boolean nonInterstitialOnly, final boolean stripUdId,
      final boolean stripZipCode, final boolean stripLatlong, final JSONObject additionalParams,
      final List<Integer> manufModelTargetingList, final double ecpmBoost, final Date eCPMBoostDate, final Long[] tod,
      final long adGroupIncId, final Integer[] AdFormatIds) {
  ...
  public void testChannelSegmentEntity() throws Exception {
    ...
    final ChannelSegmentEntity tested =
        getChannelSegmentEntityBuilder(advertiserId, adgroupId, adIds, channelId, platformTargeting, rcList, tags,
            status, isTestMode, externalSiteKey, modified_on, campaignId, slotIds, incIds, allTags, pricingModel,
            siteRatings, targetingPlatform, osIds, udIdRequired, zipCodeRequired, latlongRequired, richMediaOnly,
            appUrlEnabled, interstitialOnly, nonInterstitialOnly, stripUdId, stripZipCode, stripLatlong,
            additionalParams, manufModelTargetingList, ecpmBoost, eCPMBoostDate, tod, adGroupIncId, adFormatIds)
            .build();
