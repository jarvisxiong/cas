...
public class SiteAerospikeFeedbackRepositoryTest {
  ...
  public void testAerospikeInitConfigAndColoNull() throws Exception {
    final SiteAerospikeFeedbackRepository tested = new SiteAerospikeFeedbackRepository();
  ...
  public void testAerospikeInit() throws Exception {
    ...
    final Configuration mockConfig = createMock(Configuration.class);
    final DataCenter mockColo = createMock(DataCenter.class);
    final AerospikeClient mockAeroSpikeClient = createMock(AerospikeClient.class);
    ...
    expectNew(AerospikeClient.class, new Class[] {ClientPolicy.class, String.class, int.class}, mockClientPolicy,
        mockConfig.getString("host"), mockConfig.getInt("port")).andReturn(mockAeroSpikeClient).times(1);
    replayAll();
