...
public class RepositoryHelper {
  ...
  public RepositoryHelper(final Builder builder) {
    ...
    repositoryStatsProvider.addRepositoryToStats(nativeAdTemplateRepository).addRepositoryToStats(channelRepository)
        .addRepositoryToStats(channelAdGroupRepository).addRepositoryToStats(channelFeedbackRepository)
        .addRepositoryToStats(channelSegmentFeedbackRepository).addRepositoryToStats(siteMetaDataRepository)
        .addRepositoryToStats(siteTaxonomyRepository).addRepositoryToStats(pricingEngineRepository)
        .addRepositoryToStats(siteFilterRepository).addRepositoryToStats(siteEcpmRepository)
        .addRepositoryToStats(currencyConversionRepository).addRepositoryToStats(wapSiteUACRepository)
        .addRepositoryToStats(ixAccountMapRepository).addRepositoryToStats(creativeRepository)
        .addRepositoryToStats(nativeAdTemplateRepository);
  ...
  public SegmentAdGroupFeedbackEntity querySiteAerospikeFeedbackRepository(final String siteId, final Integer segmentId) {
