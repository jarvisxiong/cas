...
/**
 * Created by navaneeth on 1/3/16.
 */
public class CasE2EDBDetails {
    ...
    private static final String DB_PORT = System.getProperty("db_port") != null
            ...
            : "5499";
    private static final String DB_NAME = System.getProperty("db_name") != null ? System.getProperty("db_name") : "wap_prod_adserve20160222";
