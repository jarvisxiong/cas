...
public class RefineWapAdGroupData {
    ...
    public static Map<String, String> refineData(final Map<String, String> wapChnAdGrp) {
        ...
        if (wapChnAdGrp.get("additional_params") != null) {
            if (!wapChnAdGrp.get("additional_params").contains("'")) {
                wapChnAdGrp.put("additional_params", "'" + wapChnAdGrp.get("additional_params") + "'");
            }
        }
