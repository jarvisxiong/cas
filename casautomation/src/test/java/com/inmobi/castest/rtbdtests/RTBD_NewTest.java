...
public class RTBD_NewTest {
    ...
    public void Test2_1_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_2_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("taskId:,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_2_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("taskId: ,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_2_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("taskId:justlikethat,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_3_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(LogStringConf
                        .getLogString(LogStringParams.MSG_RTB_MANDATE_PARAM_MISSING),
                "remoteHostIp:, ");
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    }
    ...
    public void Test2_3_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(LogStringConf
                        .getLogString(LogStringParams.MSG_RTB_MANDATE_PARAM_MISSING),
    ...
    public void Test2_3_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG),
                "remoteHostIp:invalid,");
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    }

    @Test(testName = "Test2_4_4", dataProvider = "fender_rtbd_dp", dataProviderClass = FenderDataProvider.class)
    public void Test2_4_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("site:Site(siteIncId:0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG),
                "siteIncId:0,");
        Reporter.log(parserOutput, true);
    ...
    public void Test2_4_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                "site:Site(siteIncId:10109910,", "siteIncId=10109910,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    ...
    public void Test2_5_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("siteUrl:,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG),
                "siteUrl:,");
        Reporter.log(parserOutput, true);
    ...
    public void Test2_5_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("siteUrl: ,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_5_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("siteUrl:justlikethat",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG),
                "siteUrl:justlikethat");
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    }

    @Test(testName = "Test2_6_4", dataProvider = "fender_rtbd_dp", dataProviderClass = FenderDataProvider.class)
    public void Test2_6_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("cpcFloor:2.0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    ...
    public void Test2_6_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("cpcFloor:2.02,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    ...
    public void Test2_7_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("ecpmFloor:2.0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    ...
    public void Test2_7_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("ecpmFloor:2.02,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    ...
    public void Test2_8_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_8_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                "Terminating request as site id was missing",
    ...
    public void Test2_8_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_8_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_9_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_9_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_9_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser(
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
    ...
    public void Test2_10_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("inventoryType:BROWSER,",
                "source=WAP,");
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    }
    ...
    public void Test2_10_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("inventoryType:APP, ",
                "source=APP,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
    ...
    public void Test2_10_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("source=WAP,",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
        Reporter.log(parserOutput, true);
        Assert.assertTrue(parserOutput.equals("PASS"));
    }
    ...
    public void Test2_10_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("source=WAP,",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_10_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
		/* Deriving the parser output to assert for */
        parserOutput = LogParserHelper.logParser("source=WAP,",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_11_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_11_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_11_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser(
                "contentRatingDeprecated:MATURE,", "siteContentType=MATURE,",
    ...
    public void Test2_11_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_11_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_11_6(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_12_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTags:[70], ",
                "categories=[70],",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_12_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTags:[70, 71],",
                "categories=[70, 71],",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_12_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTags:[0],",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_12_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTags:[10000],",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_12_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTags:[],",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_12_7(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_13_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTaxonomies:[190]",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_13_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTaxonomies:[0]",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_13_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTaxonomies:[10000]",
                "categories=[10000],",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_13_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("siteTaxonomies:[]",
                "categories=[], ",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_13_7(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_14_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("userAgent:,", LogStringConf
                .getLogString(LogStringParams.MSG_RTB_MANDATE_PARAM_MISSING));
    ...
    public void Test2_14_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_14_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("userAgent:justlikethat,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_15_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("modelId:0,", "modelId=0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_15_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("modelId:1199999,",
                " modelId=1199999,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_16_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("manufacturerId:0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_16_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("manufacturerId:1010199,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_17_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("osId:3,", "osId=3,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_17_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("osId:5,", "osId=5,",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_17_6(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("osId:101,", "osId=101,",
                LogStringConf.getLogString(LogStringParams.MSG_SENDING_NO_AD));
    ...
    public void Test2_18_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("osMajorVersion:0.0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_18_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("osMajorVersion:10.0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_18_6(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("osMajorVersion:10.02",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_19_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("browserId:0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_19_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("browserId:1010,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_20_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("browserMajorVersion:0.0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_20_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("browserMajorVersion:10.0,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_20_6(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        parserOutput = LogParserHelper.logParser("browserMajorVersion:10.02,",
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_51_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {

        searchStringInLog1 = "uidParams:UidParams(rawUidValues:{GID=somevalue},";
        searchStringInLog2 = "tUidParams={GID=somevalue},";

        parserOutput = LogParserHelper.logParser(searchStringInLog1,
                searchStringInLog2,
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_51_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_51_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_51_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_52_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_52_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_52_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_52_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_54_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_54_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_54_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_54_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_55_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_55_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_55_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_55_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_56_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_56_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_57_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_57_5(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_58_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_58_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_58_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_58_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_59_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_59_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_59_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_60_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
        ...
        parserOutput = LogParserHelper.logParser(searchStringInLog1,
                searchStringInLog2, searchStringInLog3,
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
    ...
    public void Test2_60_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_60_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_65_2(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_65_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_65_3(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void Test2_41_1(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
        ...
        parserOutput = LogParserHelper.logParser(searchString1, searchString2,
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_RESPONSE),
                LogStringConf.getLogString(LogStringParams.MSG_RTBD_AdRR_FLAG));
        Reporter.log(parserOutput, true);
    ...
    public void Test2_63_4(final String x, final ResponseBuilder responseBuilder)
            throws Exception {
    ...
    public void TEST2_RTBD_SIGNALS_NULLCHECK(final String x,
                                             final ResponseBuilder responseBuilder) throws Exception {
    ...
    public void TEST2_RTBD_SIGNALS_VALIDATIONS_POSITIVE(final String x,
                                                        final ResponseBuilder responseBuilder) throws Exception {

        parserOutput = LogParserHelper
                .logParser(
                        LogStringConf
                                .getLogString(LogStringParams.MSG_RTBD_SASPARAMS_MANUFNAME_NEGATIVE),
                        LogStringConf
                                .getLogString(LogStringParams.MSG_RTBD_SASPARAMS_MODELNAME_NEGATIVE),
                        LogStringConf
                                .getLogString(LogStringParams.MSG_RTBD_MAKE_AND_MANUF_DATA_SIGNALS),
                        LogStringConf
    ...
    public void TEST2_RTBD_SIGNALS_VALIDATIONS_NEGATIVE(final String x,
                                                        final ResponseBuilder responseBuilder) throws Exception {
