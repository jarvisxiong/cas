...
public class DCPRubiconAdnetworkTest extends TestCase {
  ...
  private final String rubiconHost =
  ...
  public void testDCPrubiconConfigureParametersAppBlankUid() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(rubiconAdvId, null, null, null, 0, null,
            ...
            false, false, false, false, false, false, false, false, new JSONObject(
                "{\"3\":\"160212\",\"site\":\"191002\"}"), new ArrayList<Integer>(), 0.0d, null, null, 32,
            new Integer[] {0}));
    assertEquals(false,
        dcpRubiconAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null));
  }
  ...
  public void testDCPrubiconParseAdWap() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(rubiconAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject(
                "{\"3\":\"160212\",\"site\":\"19100\"}"), new ArrayList<Integer>(), 0.0d, null, null, 32,
            new Integer[] {0}));
    dcpRubiconAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, beaconUrl);
