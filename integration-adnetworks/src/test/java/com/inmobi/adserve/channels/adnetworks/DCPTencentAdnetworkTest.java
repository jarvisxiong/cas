...
public class DCPTencentAdnetworkTest {
    ...
    public void setUp() throws Exception {
        ...
        MemberMatcher.field(TencentAdnetwork.class, "templateConfiguration").set(TencentAdnetwork.class,
        ...
        expect(repositoryHelper.querySlotSizeMapRepository((short) 12)).andReturn(slotSizeMapEntityFor12).anyTimes();
