...
public class DCPMiaozhenAdnetworkTest extends TestCase {
    ...
    // Test request URI for APP.
    @Test
    public void testDCPMiaozhenRequestUriAPP() throws Exception {
        SASRequestParameters sasParams = new SASRequestParameters();
        CasInternalRequestParameters casInternalRequestParameters = new CasInternalRequestParameters();
    ...
    // Test request URI for WAP.
    @Test
    public void testDCPMiaozhenRequestUriWAP() throws Exception {
        SASRequestParameters sasParams = new SASRequestParameters();
        CasInternalRequestParameters casInternalRequestParameters = new CasInternalRequestParameters();
        ...
        // Compare the expected URL with actual URL after eliminating its last parameter.
        String expectedUrl = "http://s.x.cn.miaozhen.com/bx?v=0&m_ua=Mozilla%2F5.0+%28compatible%3B+MSIE+9.0%3B+Windows+NT+6.1%3B+Trident%2F5.0%29&m_ip=206.29.182.240&m_adw=300&m_adh=250&m_pos=37.4429%2C-122.1514&m_net=2&m_os=iOS&m0=202cb962ac59075b964b07152d234b70&m5=23e2ewq445545&m_int=1&l=4246";
        actualUrl = actualUrl.substring(0, actualUrl.lastIndexOf('&'));
