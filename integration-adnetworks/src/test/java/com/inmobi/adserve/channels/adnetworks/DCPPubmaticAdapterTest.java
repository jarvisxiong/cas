...
public class DCPPubmaticAdapterTest extends TestCase {
  ...
  public void DCPPubmaticAdapterTestConfigureParameters() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(pubmaticAdvId, null, null, null, 0,
            null, null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false,
            false, false, false, false, false, false, false, false, false, new JSONObject("{\"9\":\"1231\"}"),
            new ArrayList<Integer>(), 0.0d, null, null, 32, new Integer[] {0}));
    assertEquals(
        dcpPubmaticAdnetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), true);
  }
  ...
  public void testDCPPubmaticConfigureParametersBlankIP() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(pubmaticAdvId, null, null, null, 0,
            ...
            new ArrayList<Integer>(), 0.0d, null, null, 32, new Integer[] {0}));
    assertEquals(
        dcpPubmaticAdnetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), false);
  }
  ...
  public void testDCPPubmaticRequestUriSegmentCategory() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(pubmaticAdvId, null, null, null, 0,
            null, segmentCategories, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0,
  ...
  public void testDCPPubmaticRequestParams() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(pubmaticAdvId, null, null, null, 0,
            null, null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false,
            false, false, false, false, false, false, false, false, false, new JSONObject("{\"9\":\"36844\"}"),
  ...
  public void testDCPPubmaticParseResponseAd() throws Exception {
    ...
    final String beaconUrl =
        "http://c2.w.inmobi.com/c.asm/4/b/bx5/yaz/2/b/a5/m/0/0/0"
            + "/202cb962ac59075b964b07152d234b70/4f8d98e2-4bbd-40bc-87e5-22da170600f9/-1/1/9cddca11" + "?beacon=true";
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(pubmaticAdvId, null, null, null, 0,
            null, null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false,
            false, false, false, false, false, false, false, false, false, new JSONObject("{\"4\":\"36844\"}"),
            new ArrayList<Integer>(), 0.0d, null, null, 32, new Integer[] {0}));
