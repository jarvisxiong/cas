...
public class DCPMarimediaAdNetworkTest extends TestCase {
  ...
  public void testDCPMarimediaConfigureParameters() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(marimediaAdvId, "adgroupid", null, null,
            0, null, null, true, true, externalKey, null, null, null, new Long[] {1L}, true, null, null, 0, null,
