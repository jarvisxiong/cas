...
public class AdNetworksTest extends TestCase {
    ...
    public void prepareMockConfig() {
        ...
        expect(mockConfig.getString("mobilecommerce.host")).andReturn(mcHostus).anyTimes();
