...
public class AdNetworksTest extends TestCase {
  ...
  public void testDCPTapitConfigureParameters() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(tapitAdvId, null, null, null, 0, null, null, true,
            true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false, false,
            false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null, null, 32,
            new Integer[] {0}));
    assertEquals(true,
  ...
  public void testOpenxRequestUriWithIFA() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(openxAdvertiserId, null, null, null, 0, null, null,
            true, true, externalKey, null, null, null, new Long[] {32L}, true, null, null, 0, null, false, false,
  ...
  public void testOpenxRequestUri() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(openxAdvertiserId, null, null, null, 0, null, null,
            true, true, externalKey, null, null, null, new Long[] {32L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject(), new ArrayList<Integer>(), 0.0d,
  ...
  public void testDCPTapitRequestUri() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(tapitAdvId, null, null, null, 0, null, null, true,
            true, externalKey, null, null, null, new Long[] {32L}, true, null, null, 0, null, false, false, false,
            false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null, null, 32,
            new Integer[] {0}));
  ...
  public void testOpenxResponse() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(getChannelSegmentEntityBuilder(openxAdvertiserId, null, null, null, 0, null, null,
            true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false, false,
            false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null, null, 32,
            new Integer[] {0}));
