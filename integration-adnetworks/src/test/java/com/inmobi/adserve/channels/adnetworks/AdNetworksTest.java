...
public class AdNetworksTest extends TestCase {
	...
	public void testDCPTapitRequestUriWithGPID() throws Exception {
		...
		sasParams.setImpressionId("4f8d98e2-4bbd-40bc-8795-22da170700f9");
		sasParams.setSiteIncId(18);
		casInternalRequestParameters.gpid= "ASAD-SDSSD-SDADADAD-AAQW";
		...
		if (dcpTapitAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null)) {
			String actualUrl = dcpTapitAdNetwork.getRequestUri().toString();
			String expectedUrl = "http://r.tapit.com/adrequest.php?format=json&ip=206.29.182.240&ua=Mozilla&zone=19100&lat=37.4429&long=-122.1514&enctype=md5&udid=202cb962ac59075b964b07152d234b70&adid=ASAD-SDSSD-SDADADAD-AAQW&tpsid=00000000-0000-0020-0000-000000000012";
			assertEquals(expectedUrl, actualUrl);
		}
	}
