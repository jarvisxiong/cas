...
public class DCPVerveAdapterTest extends TestCase {
  ...
  public void testDCPVerveConfigureParameters() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(verveAdvId, null, null, null, 0, null,
  ...
  public void testDCPVerveConfigureParametersIPOnlySet() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(verveAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject("{\"trueLatLongOnly\":\"false\"}"),
  ...
  public void testDCPVerveConfigureParametersTrueLatLongSet() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(verveAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject("{\"trueLatLongOnly\":\"true\"}"),
            new ArrayList<Integer>(), 0.0d, null, null, 32, new Integer[] {0}));
    assertTrue(dcpVerveAdnetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null));
  }
