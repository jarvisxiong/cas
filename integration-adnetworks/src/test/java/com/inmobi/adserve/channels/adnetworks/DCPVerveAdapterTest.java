...
public class DCPVerveAdapterTest extends TestCase {
	...
	public void prepareMockConfig() {
		...
		expect(mockConfig.getString("verve.host")).andReturn(verveHost)
				.anyTimes();
		expect(mockConfig.getString("verve.status")).andReturn(verveStatus)
				.anyTimes();
		expect(mockConfig.getString("verve.advertiserId"))
				.andReturn(verveAdvId).anyTimes();
	...
	public void setUp() throws Exception {
		...
		Formatter.init();
		dcpVerveAdnetwork = new DCPVerveAdNetwork(mockConfig, null, base,
				serverChannel);
	}
	...
	@Test
	public void testDCPVerveConfigureParametersTrueLatLongSet()
	...
	public void testDCPVerveRequestUri() throws Exception {
		...
		if (dcpVerveAdnetwork.configureParameters(sasParams,
			...
			String expectedUrl = "http://adcel.vrvm.com/htmlad?ip=206.29.182.240&p=iphn&b=1324&site=00000000-0000-0000-0000-000000000000&ua=Mozilla&lat=37.4429&long=-122.1514&uis=v&ui=202cb962ac59075b964b07152d234b70&c=97&size=320x48&adunit=mma";
	...
	public void testDCPVerveRequestUriWithIPOnly() throws Exception {
		...
		if (dcpVerveAdnetwork.configureParameters(sasParams,
				casInternalRequestParameters, entity, clurl, null)) {
			String actualUrl = dcpVerveAdnetwork.getRequestUri().toString();
			String expectedUrl = "http://adcel.vrvm.com/htmlad?ip=206.29.182.240&p=iphn&b=1324&site=00000000-0000-0020-0000-000000000000&ua=Mozilla&uis=v&ui=202cb962ac59075b964b07152d234b70&c=97&size=300x250&adunit=inter";
			assertEquals(expectedUrl, actualUrl);
		}
	}
	...
	public void testDCPVerveRequestUriBannerType() throws Exception {
		...
		if (dcpVerveAdnetwork.configureParameters(sasParams,
				casInternalRequestParameters, entity, clurl, null)) {
			String actualUrl = dcpVerveAdnetwork.getRequestUri().toString();
			String expectedUrl = "http://adcel.vrvm.com/htmlad?ip=206.29.182.240&p=ptnr&b=1324&site=00000000-0000-0000-0000-000000000000&ua=Mozilla&lat=37.4429&long=-122.1514&c=97&size=728x90&adunit=banner";
			assertEquals(expectedUrl, actualUrl);
		}
	}
