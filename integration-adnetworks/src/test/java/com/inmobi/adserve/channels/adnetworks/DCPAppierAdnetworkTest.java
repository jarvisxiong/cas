...
public class DCPAppierAdnetworkTest extends TestCase {
    ...
    public void testDCPAppierConfigureParameters() {
        ...
        assertEquals(
            dcpAppierAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), true);
    }
    ...
    public void testDCPAppierConfigureParametersBlankIP() {
        ...
        ChannelSegmentEntity entity = new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(
            ...
            new ArrayList<Integer>(), 0.0d, null, null, 32));
        assertEquals(
            dcpAppierAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), false);
    }
    ...
    public void testDCPAppierRequestUri() throws Exception {
        ...
        ChannelSegmentEntity entity = new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(
            appierAdvId, null, null, null, 0, null, segmentCategories, true, true, externalKey, null, null, null, 0,
    ...
    public void testDCPAppierRequestUriBlankLatLong() throws Exception {
        ...
        ChannelSegmentEntity entity = new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(
            ...
            null, 0, null, false, false, false, false, false, false, false, false, false, false, null,
            new ArrayList<Integer>(), 0.0d, null, null, 0));
        if (dcpAppierAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null)) {

            ChannelBuffer actualUrl = dcpAppierAdNetwork.getHttpRequest().getContent(); // .getRequestUri().toString();
            String expectedUrl = "version=1&reqid=4f8d98e2-4bbd-40bc-8795-22da170700f9&segkey=1324&clientip=206.29.182.240&bsiteid=00000000-0000-0000-0000-000000000000&sitetype=1&ua=Mozilla&categories=Board%2CAdventure&size=320x50&um5=202cb962ac59075b964b07152d234b70&siterating=FAMILY_SAFE";
            ChannelBuffer expectedUrlBuffer = ChannelBuffers.copiedBuffer(expectedUrl, CharsetUtil.UTF_8);
            assertEquals(actualUrl, expectedUrlBuffer);
        }
    }
    ...
    public void testDCPAppierRequestUriBlankSlot() throws Exception {
        ...
        if (dcpAppierAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null)) {
            ChannelBuffer actualUrl = dcpAppierAdNetwork.getHttpRequest().getContent(); // .getRequestUri().toString();
            String expectedUrl = "version=1&reqid=4f8d98e2-4bbd-40bc-8795-22da170700f9&segkey=test&clientip=206.29.182.240&bsiteid=00000000-0000-0000-0000-000000000000&sitetype=1&ua=Mozilla&categories=Board%2CAdventure&lat=37.4429&long=-122.1514&um5=202cb962ac59075b964b07152d234b70&siterating=Performance";
            ChannelBuffer expectedUrlBuffer = ChannelBuffers.copiedBuffer(expectedUrl, CharsetUtil.UTF_8);
            assertEquals(actualUrl, expectedUrlBuffer);
        }
    }
