...
public class DCPLoganAdnetworkTest extends TestCase {
    ...
    public void testDCPLoganConfigureParameters() {
        ...
        assertEquals(
            dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), true);
    }
    ...
    public void testDCPLoganConfigureParametersBlankIP() {
        ...
        ChannelSegmentEntity entity = new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(
            ...
            new ArrayList<Integer>(), 0.0d, null, null, 32));
        assertEquals(
            dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), false);
    }
