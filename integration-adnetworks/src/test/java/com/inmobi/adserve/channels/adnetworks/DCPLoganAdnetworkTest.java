...
public class DCPLoganAdnetworkTest {
    private static final String debug = "debug";
    private static final String loggerConf = "/tmp/channel-server.properties";
    private static final String loganHost = "http://ads.mocean.mobi/ad?track=1&key=6&type=3&over_18=0";
    private static final String loganStatus = "on";
    private static final String loganAdvId = "loganadv1";
    private static final String loganTest = "1";
    private static Configuration mockConfig = null;
    private static DCPLoganAdnetwork dcpLoganAdNetwork;
    ...
    public void testDCPLoganConfigureParameters() {
        ...
        assertEquals(
                dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 15, repositoryHelper),
                true);
    }
    ...
    public void testDCPLoganRequestUri() throws Exception {
        ...
        if (dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 15, repositoryHelper)) {
    ...
    public void testDCPLoganRequestUriBlankSlot() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(loganAdvId, null, null, null, 0,
                        ...
                        null, false, false, false, false, false, false, false, false, false, false, null,
                        new ArrayList<>(), 0.0d, null, null, 0, new Integer[] {0}));
        if (dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, Short.MAX_VALUE, repositoryHelper)) {
            final String actualUrl = dcpLoganAdNetwork.getRequestUri().toString();
            final String expectedUrl =
    ...
    public void testDCPLoganParseResponseHtml() throws Exception {
        ...
        assertEquals(dcpLoganAdNetwork.getHttpResponseStatusCode(), 200);
        assertEquals(
                "<html><head><title></title><meta name=\"viewport\" content=\"user-scalable=0, minimum-scale=1.0, maximum-scale=1.0\"/><style type=\"text/css\">body {margin: 0px; overflow: hidden;} </style></head><body><a href=\"http://ads.mocean.mobi/8/redir/0beda220-76e8-11e3-9ca3-b8ca3a685e3a/0/413716\" target=\"_blank\"><img width=\"320\" height=\"50\" style=\"border-style: none\" src=\"http://cdn.adnxs.com/p/ac/e3/11/39/ace3113973d0b2f42bb7fafc21f1303c.png\"/></a><img src=\"http://falcon828.startdedicated.com/oapi/getAd;jsessionid=CE95AD7724915C3AF30B6A9251A05F1C.falcon828\" width=\"1\" height=\"1\" /><img src=\"http://ads.mocean.mobi/8/img/0beda220-76e8-11e3-9ca3-b8ca3a685e3a\" width=\"1\" height=\"1\" alt=\"\"/><img src='http://ads.mocean.mobi/8/img/0beda220-76e8-11e3-9ca3-b8ca3a685e3a?redir=http%3A%2F%2Ffalcon828.startdedicated.com%2Foapi%2FgetAd%3Bjsessionid%3DCE95AD7724915C3AF30B6A9251A05F1C.falcon828' height=1 width=1 border=0 style=\"display:none;\"/><img src='beaconUrl' height=1 width=1 border=0 style=\"display:none;\"/></body></html>",
                dcpLoganAdNetwork.getHttpResponseContent());
    }
    ...
    public void testDCPLoganParseResponseTextAdWAP() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(loganAdvId, null, null, null, 0,
                        ...
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        AdapterTestHelper.setBeaconAndClickStubs();
        dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 4, repositoryHelper);
