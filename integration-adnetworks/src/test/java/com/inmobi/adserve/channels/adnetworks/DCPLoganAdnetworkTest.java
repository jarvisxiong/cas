...
public class DCPLoganAdnetworkTest extends TestCase {
  ...
  public void testDCPLoganConfigureParameters() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(loganAdvId, null, null, null, 0, null,
            ...
            32, new Integer[] {0}));
    assertEquals(dcpLoganAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null),
        true);
  }
