...
public class DCPWapStartAdnetworkTest extends TestCase {
  ...
  public void testDCPWapstartConfigureParameters() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(wapstartAdvId, null, null, null, 0,
    ...
    assertEquals(
        dcpWapstartAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), true);
  }
  ...
  public void testDCPWapstartConfigureParametersBlankSlot() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(wapstartAdvId, null, null, null, 0,
            ...
            null, 32, new Integer[] {0}));
    assertEquals(
        dcpWapstartAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), false);
  }
  ...
  public void testDCPWapstartRequestUri() throws Exception {
    ...
    final String externalKey = "1324";// http://jt.red.ua2.inmobi.com:50030/jobdetails.jsp?jobid=job_201409160535_17554
    SlotSizeMapping.init();
    final String clurl =
        "http://c2.w.inmobi.com/c.asm/4/b/bx5/yaz/2/b/a5/m/0/0/0/202cb962ac59075b964b07152d234b70/4f8d98e2-4bbd-40bc-87e5-22da170600f9/-1/1/9cddca11?ds=1";
    final ChannelSegmentEntity entity =
  ...
  public void testDCPWapstartRequestUriBlankLatLong() throws Exception {
    ...
    final String actualResponse = request.getStringData();
    final String expectedResponse =
        "{\"impression\":{\"banner\":[{\"h\":50,\"w\":320,\"api\":5,\"btype\":1}]},\"site\":{\"id\":1324,\"ctype\":1,\"publisher\":{\"id\":23232,\"name\":\"00000000-0000-0020-0000-000000005ac0\"}},\"device\":{\"ip\":\"206.29.182.240\",\"ua\":\"Mozilla\",\"android_id\":\"202cb962ac59075b964b07152d234b70\",\"geo\":{\"country\":\"CN\"}},\"user\":{\"yob\":0,\"gender\":2,\"data\":{\"name\":\"wapstart\",\"segment\":{\"name\":\"login\",\"value\":\"202cb962ac59075b964b07152d234b70\"}}}}";
    assertEquals(actualResponse, expectedResponse);
