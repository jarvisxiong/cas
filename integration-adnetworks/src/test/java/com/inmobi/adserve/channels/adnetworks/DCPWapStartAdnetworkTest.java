...
public class DCPWapStartAdnetworkTest extends TestCase {
	...
	public void testDCPWapstartRequestUri() throws Exception {
		...
		String expectedResponse = "{\"impression\":{\"banner\":[{\"h\":50,\"w\":320,\"api\":5,\"btype\":1}]},\"site\":{\"id\":1324,\"ctype\":1,\"publisher\":{\"id\":23232,\"name\":\"00000000-0000-0020-0000-000000005ac0\"}},\"device\":{\"ip\":\"206.29.182.240\",\"ua\":\"Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_0 like Mac OS X; en-us) AppleWebKit/532.9 (KHTML, like Gecko) Version/4.0.5 Mobile/8A293 Safari/6531.22.7\",\"geo\":{\"lat\":\"37.4429\",\"lon\":\"-122.1514\",\"country\":\"RU\"}},\"user\":{\"uid\":\"202cb962ac59075b964b07152d234b70\",\"yob\":0,\"gender\":2}}";
	...
	public void testDCPWapstartRequestUriBlankLatLong() throws Exception {
		...
		Request request = dcpWapstartAdNetwork.getNingRequest();
		String actualResponse = request.getStringData();
		String expectedResponse = "{\"impression\":{\"banner\":[{\"h\":50,\"w\":320,\"api\":5,\"btype\":1}]},\"site\":{\"id\":1324,\"ctype\":1,\"publisher\":{\"id\":23232,\"name\":\"00000000-0000-0020-0000-000000005ac0\"}},\"device\":{\"ip\":\"206.29.182.240\",\"ua\":\"Mozilla\",\"geo\":{\"country\":\"CN\"}},\"user\":{\"uid\":\"202cb962ac59075b964b07152d234b70\",\"yob\":0,\"gender\":2}}";
		assertEquals(actualResponse, expectedResponse);
	...
	public void testDCPWapstartParseResponseHtml() throws Exception {
		...
		String response = "{	\"seat\":[		{			\"id\":206,			\"clink\":\"http://clck.plus1.wapstart.ru/index.php?area=redirector&type=1&rsId=testmorda_8d96ef29804d719fb481d1de4c580aea548f2e41_08061235&site=8&banner=206&usr=\",			\"vlink\":\"http://api.plus1.wapstart.ru/v1/track/view/8.gif/?sid=testmorda_8d96ef29804d719fb481d1de4c580aea548f2e41_08061235\",			\"text\":{				\"title\":\"Sample ad\",				\"short\":\"Sample ad as one-liner\"			}		}	]}";
