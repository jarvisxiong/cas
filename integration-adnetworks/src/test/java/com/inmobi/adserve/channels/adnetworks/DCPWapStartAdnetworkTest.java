...
public class DCPWapStartAdnetworkTest extends TestCase {
    ...
    public void testDCPWapstartRequestUri() throws Exception {
        ...
        if (dcpWapstartAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null)) {
            ...
            String expectedUrl = "http://ro.plus1.wapstart.ru?version=2&encoding=1&area=viewBannerXml&ip=206.29.182.240&id=1324&pageId=00000000000000200000000000000000&kws=Food+%26+Drink%3BAdventure%3BWord&location=37.4429%2C-122.1514";
    ...
    public void testDCPWapstartRequestUriBlankLatLong() throws Exception {
        ...
        if (dcpWapstartAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null)) {
            String actualUrl = dcpWapstartAdNetwork.getRequestUri().toString();
            String expectedUrl = "http://ro.plus1.wapstart.ru?version=2&encoding=1&area=viewBannerXml&ip=206.29.182.240&id=1324&pageId=00000000000000200000000000000000&kws=Food+%26+Drink%3BAdventure%3BWord";
            assertEquals(expectedUrl, actualUrl);
        }
    }
