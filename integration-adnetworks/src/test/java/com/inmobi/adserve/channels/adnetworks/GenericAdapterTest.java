...
public class GenericAdapterTest extends TestCase {
  ...
  public void prepareMockConfig() {
    ...
    expect(mockConfig.getString(advertiserName.concat(MacrosAndStrings.REQUEST_METHOD))).andReturn("get").anyTimes();
    ...
    expect(mockConfig.getString(advertiserName.concat(MacrosAndStrings.REQUEST_PARAMETERS)))
        ...
        .anyTimes();
    expect(mockConfig.getString(advertiserName.concat(MacrosAndStrings.RESPONSE_FORMAT))).andReturn("json").anyTimes();
  ...
  public void testGenericAdapterConfigureParameters() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvertiserId, null, null, null,
            0, null, null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null,
            false, false, false, false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d,
            null, null, 32, new Integer[] {0}));
    assertEquals(genericAdapter.configureParameters(sasParams, casInternalRequestParameters, entity, null, beaconUrl),
        true);
  }
  ...
  public void testGenericAdapterConfigureParametersNullExtSiteKey() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvertiserId, null, null, null,
            0, null, null, true, true, null, null, null, null, new Long[] {0L}, true, null, null, 0, null, false,
            false, false, false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null,
            null, 32, new Integer[] {0}));
    assertEquals(genericAdapter.configureParameters(sasParams, casInternalRequestParameters, entity, null, null), false);
  }
