...
public class DCPStartMeAppAdnetworkTest extends TestCase {
    private Configuration mockConfig = null;
    private final String debug = "debug";
    private final String loggerConf = "/tmp/channel-server.properties";
    private final Bootstrap clientBootstrap = null;
    private DCPStartMeAppAdnetwork dcpStartMeAppAdnetwork;
    private String StartMeAppHost = "http://api.rtb.startmeapp.net/request";
    private final String StartMeAppStatus = "on";
    private final String StartMeAppAdspace= "1234567";
    private final String StartMeappAdvId = "StartMeAppadv1";
    private final String StartMeAppTest = "1";
    private final String pubId = "1q2w3e";
