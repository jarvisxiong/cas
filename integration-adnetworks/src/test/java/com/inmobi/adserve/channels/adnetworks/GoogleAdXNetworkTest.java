...
public class GoogleAdXNetworkTest extends TestCase {
  ...
  public void testGoogleAdXNetworkConfigureParameters() throws JSONException {
    ...
    ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(googleAdXPublisherID, null, null, null,
            0, null, null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null,
            false, false, false, false, false, false, false, false, false, false,
            new JSONObject("{\"pos\":\"header\"}"), new ArrayList<Integer>(), 0.0d, null, null, 32, new Integer[] {0}));
