...
public class DCPAmobeePlatformAdnetworkTest {
    ...
    private static final String dmgHost = "http://ad.dmg-mobile.com/upsteed/wap/adrequest?acc=17067024";
    private static final String dmgStatus = "on";
    private static final String dmgAdvId = "dmgadv1";
    private static final String dmgTest = "1";
    private static final String dmgAdNetworkId = "test";
    private static Configuration mockConfig = null;
    private static DCPAmobeePlatformAdnetwork dcpDmgAdNetwork;
    ...
    public void testDCPDmgConfigureParameters() throws JSONException {
        ...
        assertEquals(true,
                dcpDmgAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 11, repositoryHelper));
    }
    ...
    public void testDCPDmgRequestUri() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(dmgAdvId, null, null, null, 0,
                        ...
                        null, false, false, false, false, false, false, false, false, false, false, null,
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        if (dcpDmgAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 15, repositoryHelper)) {
    ...
    public void testDCPDmgParseAd() throws Exception {
        ...
        dcpDmgAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 15, repositoryHelper);
