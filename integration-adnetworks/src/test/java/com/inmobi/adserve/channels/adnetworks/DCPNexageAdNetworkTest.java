...
public class DCPNexageAdNetworkTest extends TestCase {
  ...
  public void testDCPNexageConfigureParameters() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(NexageAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject("{\"pos\":\"header\"}"),
  ...
  public void testDCPNexageConfigureParametersWithAdditionalParamsNotSet() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(NexageAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject("{}"), new ArrayList<Integer>(),
  ...
  public void testDCPNexageRequestUriWithSegmentCategory() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(NexageAdvId, null, null, null, 0, null,
            categories, true, true, externalKey, null, null, null, new Long[] {0L}, false, null, null, 0, null, false,
            false, false, false, false, false, false, false, false, false, new JSONObject(new JSONObject(
  ...
  public void testDCPNexageRequestUriforiPad() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(NexageAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject("{\"pos\":\"leader\"}"),
            new ArrayList<Integer>(), 0.0d, null, null, 0, new Integer[] {0}));
    if (dcpNexageAdnetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, burl)) {
      final String actualUrl = dcpNexageAdnetwork.getRequestUri().toString();
      final String expectedUrl =
  ...
  public void testDCPNexageRequestUriWithBlindedSiteId() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(NexageAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {56789L}, true, null, null, 0, null, false,
            false, false, false, false, false, false, false, false, false, new JSONObject("{\"pos\":\"header\"}"),
            new ArrayList<Integer>(), 0.0d, null, null, 56789, new Integer[] {0}));
    if (dcpNexageAdnetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, burl)) {
      final String actualUrl = dcpNexageAdnetwork.getRequestUri().toString();
      final String expectedUrl =
  ...
  public void testDCPNexageGenerateStaticJsAdTag() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(NexageAdvId, null, null, null, 0, null,
            null, true, true, externalKey, null, null, null, new Long[] {0L}, true, null, null, 0, null, false, false,
            false, false, false, false, false, false, false, false, new JSONObject(
