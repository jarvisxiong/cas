...
public class DCPHuntmadsAdNetworksTest extends TestCase {
  ...
  public void testDCPHuntmadsConfigureParameters() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(huntmadsAdvId, null, null, null, 0,
    ...
    assertEquals(
        dcpHuntmadsAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), true);
  }
  ...
  public void testDCPHuntmadsConfigureParametersBlankIP() {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(huntmadsAdvId, null, null, null, 0,
            ...
            null, 32, new Integer[] {0}));
    assertEquals(
        dcpHuntmadsAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null), false);
  }
  ...
  public void testDCPHuntmadsParseInvalidResponse() throws Exception {
    final String response = "HTTP/1.1 20a OK\nServer=Netscape-Enterprise/4.1\n\n[{\"error\" : \"No ads available\"}];";
    dcpHuntmadsAdNetwork.parseResponse(response, HttpResponseStatus.OK);
