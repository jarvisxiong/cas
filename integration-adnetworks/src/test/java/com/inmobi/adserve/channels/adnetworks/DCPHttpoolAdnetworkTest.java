...
public class DCPHttpoolAdnetworkTest {
    private static final String debug = "debug";
    private static final String loggerConf = "/tmp/channel-server.properties";
    private static final String httpoolHost = "http://a.mobile.toboads.com/get?ormma=0&fh=0&sdkid=api&sdkver=100&";
    private static final String httpoolStatus = "on";
    private static final String httpoolAdvId = "httpooladv1";
    private static final String httpoolTest = "1";
    private static Configuration mockConfig = null;
    private static DCPHttPoolAdNetwork dcpHttpoolAdNetwork;
    ...
    public void testDCPHttpoolConfigureParameters() {
        ...
        assertEquals(true,
                dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 14, repositoryHelper));
    }
    ...
    public void testDCPHttpoolRequestUri() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvId, null, null, null,
                        ...
                        null, false, false, false, false, false, false, false, false, false, false, null,
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        if (dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity,
    ...
    public void testDCPHttpoolRequestUriMale() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvId, null, null, null,
                        ...
                        null, false, false, false, false, false, false, false, false, false, false, null,
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        if (dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 9, repositoryHelper)) {
            final String actualUrl = dcpHttpoolAdNetwork.getRequestUri().toString();
            final String expectedUrl =
    ...
    public void testDCPHttpoolRequestUriBlankLatLong() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvId, null, null, null,
                        ...
                        null, false, false, false, false, false, false, false, false, false, false, null,
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        if (dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 15, repositoryHelper)) {
            final String actualUrl = dcpHttpoolAdNetwork.getRequestUri().toString();
            final String expectedUrl =
    ...
    public void IgnoreTestDCPHttpoolRequestUriBlankSlot() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvId, null, null, null,
                        ...
                        null, false, false, false, false, false, false, false, false, false, false, null,
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        if (dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, Short.MAX_VALUE, repositoryHelper)) {
            final String actualUrl = dcpHttpoolAdNetwork.getRequestUri().toString();
            final String expectedUrl =
    ...
    public void testDCPHttpoolParseResponseImg() throws Exception {
        ...
        dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 15, repositoryHelper);
    ...
    public void testDCPHttpoolParseResponseTextAdWap() throws Exception {
        ...
        final ChannelSegmentEntity entity =
                new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(httpoolAdvId, null, null, null,
                        ...
                        new ArrayList<>(), 0.0d, null, null, 32, new Integer[] {0}));
        AdapterTestHelper.setBeaconAndClickStubs();
        dcpHttpoolAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, (short) 4, repositoryHelper);
        final String response =
