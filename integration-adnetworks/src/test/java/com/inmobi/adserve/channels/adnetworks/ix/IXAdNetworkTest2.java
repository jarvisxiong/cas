...
public class IXAdNetworkTest2 {
  ...
  private static void prepareMockConfig() {
    ...
    expect(mockConfig.getString(advertiserName + ".wnUrlback")).andReturn(
        "http://partner-wn.dummy-bidder.com/callback/${AUCTION_ID}/${AUCTION_BID_ID}/${AUCTION_PRICE}").anyTimes();
  ...
  public void testParseResponseNoAd() {
    ...
    final IXAdNetwork ixAdNetwork = new IXAdNetwork(mockConfig, null, null, null, null, advertiserName, 0, null, false);
  ...
  public void testParseResponsePassedDeserializationBannerBuilding() throws Exception {
    ...
    final IXAdNetwork ixAdNetwork =
        createMockBuilder(IXAdNetwork.class)
            ...
            .withConstructor(mockConfig, new Bootstrap(), mockHttpRequestHandlerBase, mockChannel, "", advertiserName,
                0, mockRepositoryHelper, true).createMock();
    ...
    ixAdNetwork.configureParameters(mockSasParams, null, mockChannelSegmentEntity, TestUtils.SampleStrings.clickUrl,
        TestUtils.SampleStrings.beaconUrl);
    Formatter.init();
  ...
  public void testUpdateDSPAccountInfo() {
    ...
    expect(mockChannelAdGroupRepo.getEntities(dummyAccountId)).andReturn(null).times(1)
        .andReturn(new ArrayList<ChannelSegmentEntity>()).times(1).andReturn(Arrays.asList(mockChannelSegmentEntity))
        .anyTimes();
    ...
    replay(mockHttpRequestHandlerBase, mockChannel, mockRepositoryHelper, mockAccountEntity, mockChannelAdGroupRepo,
        mockChannelSegmentEntity, mockSasParams);
