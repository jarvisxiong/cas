...
public class DCPPlaceIQAdnetworkTest extends TestCase {
  ...
  public void testDCPPlaceiqConfigureParametersAndroid() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(placeiqAdvId, null, null, null, 0, null,
  ...
  public void testDCPPlaceiqConfigureParametersWithGeoAndNoUid() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(placeiqAdvId, null, null, null, 0, null,
            ...
            false, false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null, null,
            32, new Integer[] {0}));
    assertFalse(dcpPlaceIQAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null));
  }
