...
public class DCPPlaceIQAdnetworkTest extends TestCase {
	...
	public void testDCPPlaceiqConfigureParametersAndroid() throws JSONException {
		...
		ChannelSegmentEntity entity = new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(
				placeiqAdvId, null, null, null, 0, null, null, true, true, externalKey, null, null, null, new Long[] {0L}, true,
	...
	public void testDCPPlaceiqRequestUri() throws Exception {
		...
		dcpPlaceIQAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, null);
	...
	public void testDCPPlaceiqRequestUriWithNoCat() throws Exception {
		...
		if (dcpPlaceIQAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, null)) {
			String actualUrl = dcpPlaceIQAdNetwork.getRequestUri().toString();
			String expectedUrl = "http://test.ads.placeiq.com/2/ad?RT=ss&ST=xml&PT=IMB&AU=PlaceIQ_test_7%2Fuc%2F6456fc%2F0&IP=206.29.182.240&UA=Mozilla&DO=Android&LT=37.4429&LG=-122.1514&SZ=320x50&GR=ABDC-ASDW-EWFJ-FHSA&AM=202cb962ac59075b964b07152d234b70&AP=6575868&AT=STG%2CRMG%2CMRD";
			assertEquals(expectedUrl, actualUrl);
		}
	}
	...
	public void testDCPPlaceiqRequestUriWithInterstitial() throws Exception {
		...
		if (dcpPlaceIQAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, null)) {
			String actualUrl = dcpPlaceIQAdNetwork.getRequestUri().toString();
			String expectedUrl = "http://test.ads.placeiq.com/2/ad?RT=ss&ST=xml&PT=IMB&AU=PlaceIQ_test_7%2Fuc%2F6456fc%2F0&IP=206.29.182.240&UA=Mozilla&DO=Android&LT=37.4429&LG=-122.1514&SZ=320x480&AM=202cb962ac59075b964b07152d234b70&AP=6575868&AT=STG%2CRMG%2CMRD%2CMRI";
			assertEquals(expectedUrl, actualUrl);
		}
	}
