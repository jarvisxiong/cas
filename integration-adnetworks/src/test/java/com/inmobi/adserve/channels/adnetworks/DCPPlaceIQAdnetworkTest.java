...
public class DCPPlaceIQAdnetworkTest extends TestCase {
    ...
    public void testDCPPlaceiqRequestUri() throws Exception {
        ...
        if (dcpPlaceIQAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, null)) {
            ...
            String expectedUrl = "http://test.ads.placeiq.com/1.41/ad?RT=xml&SK="
                    + secret
                    + "&PT=IMB&AU=IMB%2Fbusiness%2F6456fc%2F0&IP=206.29.182.240&UA=Mozilla&DO=Android&LT=37.4429&LG=-122.1514&SZ=320x50&AM=202cb962ac59075b964b07152d234b70&AP=6575868&AT=STI";
    ...
    public void testDCPPlaceiqRequestUriWithNoCat() throws Exception {
        ...
        if (dcpPlaceIQAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, null)) {
            ...
            String expectedUrl = "http://test.ads.placeiq.com/1.41/ad?RT=xml&SK="
                    + secret
                    + "&PT=IMB&AU=IMB%2Fnocat%2F6456fc%2F0&IP=206.29.182.240&UA=Mozilla&DO=Android&LT=37.4429&LG=-122.1514&SZ=320x50&AM=202cb962ac59075b964b07152d234b70&AP=6575868&AT=STI";
            assertEquals(expectedUrl, actualUrl);
        }
    }
