...
public class DCPPlaceIQAdnetworkTest extends TestCase {
	...
	public void prepareMockConfig() {
		...
		expect(mockConfig.getString("placeiq.host")).andReturn(placeiqHost)
				.anyTimes();
		expect(mockConfig.getString("placeiq.status")).andReturn(placeiqStatus)
				.anyTimes();
		expect(mockConfig.getString("placeiq.test")).andReturn(placeiqTest)
				.anyTimes();
		expect(mockConfig.getString("placeiq.advertiserId")).andReturn(
				placeiqAdvId).anyTimes();
		expect(mockConfig.getString("placeiq.partnerId")).andReturn(
				placeiqPartnerId).anyTimes();
		expect(mockConfig.getString("placeiq.seed")).andReturn(placeiqSeed)
				.anyTimes();
		expect(mockConfig.getString("placeiq.requestFormat")).andReturn(
				placeiqRequestFormat).anyTimes();
		expect(mockConfig.getString("placeiq.responseFormat")).andReturn(
				placeiqResponseFormat).anyTimes();
	...
	public void setUp() throws Exception {
		...
		Formatter.init();
		dcpPlaceIQAdNetwork = new DCPPlaceIQAdnetwork(mockConfig, null, base,
				serverChannel);
	}
	...
	public void testDCPPlaceiqConfigureParametersAndroid() throws JSONException {
		...
		ChannelSegmentEntity entity = new ChannelSegmentEntity(
				AdNetworksTest.getChannelSegmentEntityBuilder(placeiqAdvId,
						...
						0.0d, null, null, 32));
		assertEquals(true, dcpPlaceIQAdNetwork.configureParameters(sasParams,
				casInternalRequestParameters, entity, clurl, null));
	}

	@Test
	public void testDCPPlaceiqConfigureParametersWithGeoAndNoUid()
		...
		ChannelSegmentEntity entity = new ChannelSegmentEntity(
				AdNetworksTest.getChannelSegmentEntityBuilder(placeiqAdvId,
						...
						false, false, false, null, new ArrayList<Integer>(),
						0.0d, null, null, 32));
		assertFalse(dcpPlaceIQAdNetwork.configureParameters(sasParams,
				casInternalRequestParameters, entity, clurl, null));
	}
	...
	public void testDCPPlaceiqConfigureParametersBlankIP() {
		...
		ChannelSegmentEntity entity = new ChannelSegmentEntity(
				AdNetworksTest.getChannelSegmentEntityBuilder(placeiqAdvId,
						...
						false, false, false, null, new ArrayList<Integer>(),
						0.0d, null, null, 32));
		assertEquals(false, dcpPlaceIQAdNetwork.configureParameters(sasParams,
				casInternalRequestParameters, entity, clurl, null));
	}
	...
	public void testDCPPlaceiqRequestUri() throws Exception {
		...
		ChannelSegmentEntity entity = new ChannelSegmentEntity(
				AdNetworksTest.getChannelSegmentEntityBuilder(placeiqAdvId,
						...
						false, false, false, null, new ArrayList<Integer>(),
						0.0d, null, null, 0));
		if (dcpPlaceIQAdNetwork.configureParameters(sasParams,
	...
	public void testDCPPlaceiqParseAd() throws Exception {
		...
		dcpPlaceIQAdNetwork.configureParameters(sasParams,
	...
	public void testDCPPlaceiqGetImpressionId() throws Exception {
		...
		assertEquals("4f8d98e2-4bbd-40bc-8795-22da170700f9",
				dcpPlaceIQAdNetwork.getImpressionId());
	}
