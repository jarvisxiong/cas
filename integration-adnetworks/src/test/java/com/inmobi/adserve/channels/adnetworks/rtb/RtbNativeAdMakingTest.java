...
/**
 * Created by ishanbhatnagar on 12/12/14.
 * Adheres to the following Native contract:
 *  InMobi OpenRTB v2.x Extension for Native Ads v1.1
 */
...
public class RtbNativeAdMakingTest {
    ...
    private static BidResponse getBidResponseMock(String adm) {
    ...
    public void testAppDeserialisationFailure() throws Exception{
        ...
        expect(mockRepositoryHelper.queryNativeAdTemplateRepository(siteId))
                .andReturn(mockNativeAdTemplateEntity).anyTimes();
    ...
    public void testAppValidation() throws Exception{
        ...
        expect(mockRepositoryHelper.queryNativeAdTemplateRepository(siteId))
                .andReturn(mockNativeAdTemplateEntity).anyTimes();
        expect(mockNativeAdTemplateEntity.getMandatoryKey())
                .andReturn(NativeConstrains.LAYOUT_CONSTRAINT_1).times(3)
                .andReturn(NativeConstrains.LAYOUT_CONSTRAINT_2).times(3)
                .andReturn(NativeConstrains.LAYOUT_CONSTRAINT_3).times(3);
        expect(mockNativeAdTemplateEntity.getImageKey())
                .andReturn(NativeConstrains.INM_TAG_A056).times(9);

        replayAll();
        MemberModifier.field(RtbAdNetwork.class, "repositoryHelper").set(rtbAdNetwork, mockRepositoryHelper);

        String[] adMarkup = new String[] {
                "{title:\"Title\",iconurl:\"http://www.IconUrl.com\",image:{w:319,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{iconurl:\"http://www.IconUrl.com\",image:{w:320,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{title:\"Title\",image:{w:320,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{description:\"Description\",iconurl:\"http://www.IconUrl.com\",image:{w:319,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{title:\"Title\",description:\"Description\",image:{w:319,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{title:\"Title\",iconurl:\"http://www.IconUrl.com\",image:{w:319,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{iconurl:\"http://www.IconUrl.com\",image:{w:319,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{title:\"Title\",image:{w:319,h:320,imageurl=\"http://www.ImageUrl.com\"}}",
                "{title:\"Title\",iconurl:\"http://www.IconUrl.com\"}"
        };
    ...
    public void testNativeResponseContentVariation1() throws Exception {
        ...
        expect(Formatter.getNamespace()).andReturn(namespace).anyTimes();
        expect(mockRepositoryHelper.queryNativeAdTemplateRepository(siteId))
                .andReturn(mockNativeAdTemplateEntity).anyTimes();
        expect(mockNativeAdTemplateEntity.getMandatoryKey())
                .andReturn(NativeConstrains.LAYOUT_CONSTRAINT_3).anyTimes();
        expect(mockNativeAdTemplateEntity.getImageKey())
                .andReturn(NativeConstrains.INM_TAG_A056).anyTimes();

        replayAll();
        MemberModifier.field(RtbAdNetwork.class, "repositoryHelper").set(rtbAdNetwork, mockRepositoryHelper);

        String expectedResponseContent = "{\"pubContent\":\"eyJ0aXRsZSI6IkhlbGxvIFdvcmxkIiwic3VidGl0bGUiOiJJIGFtIGEgZGV"
                + "zY3JpcHRpb24iLCJsYW5kaW5nX3VybCI6ImFjdGlvbmxpbmsuaW5tb2JpLmNvbSIsImljb25fOTBYOTAiOnsidyI6MzAwLCJoIjo"
                + "zMDAsInVybCI6Ind3dy5pbm1vYmkuY29tIn0sImltYWdlXzU3Nlg2MzAiOnsidyI6MzIwLCJoIjo5ODAsInVybCI6Imh0dHA6Ly9"
                + "kZW1vLmltYWdlLmNvbSJ9fQ\\u003d\\u003d\",\"contextCode\":\"\\u003cscript type\\u003d\\\"text/javascri"
    ...
    public void testNativeResponseContentVariation2() throws Exception {
        ...
        String expectedResponseContent = "{\"pubContent\":\"eyJ0aXRsZSI6IuWqmuS4ieWbvS3ljbPml7bmiJjmlpfljaHniYwiLCJzdWJ"
                + "0aXRsZSI6IuaMh+WwluaOqOWhlO+8jOWqmuWwhuaXoOWPjO+8geWIm+aWsOaAp+exu2RvdGHljaHniYzmiYvmuLjjgIrlqprkuIn"
                + "lm73jgIvluKbkvaDmiJjotbfmnaXvvIEiLCJsYW5kaW5nX3VybCI6ImFjdGlvbmxpbmsuaW5tb2JpLmNvbSIsImljb25fOTBYOTA"
                + "iOnsidyI6MzAwLCJoIjozMDAsInVybCI6Ind3dy5pbm1vYmkuY29tIn0sImltYWdlXzU3Nlg2MzAiOnsidyI6MzIwLCJoIjo5ODA"
                + "sInVybCI6Imh0dHA6Ly9kZW1vLmltYWdlLmNvbSJ9fQ\\u003d\\u003d\",\"contextCode\":\"\\u003cscript type"
                + "\\u003d\\\"text/javascri"
                + "pt\\\" src\\u003d\\\"mraid.js\\\"\\u003e\\u003c/script\\u003e\\n\\u003cdiv style\\u003d\\\"display:n"
                + "one; position:absolute;\\\" id\\u003d\\\"namespaceclickTarget\\\"\\u003e\\u003c/div\\u003e\\n\\u003c"
                + "script type\\u003d\\\"text/javascript\\\"\\u003e\\n(function() {\\nvar e\\u003dencodeURIComponent,"
