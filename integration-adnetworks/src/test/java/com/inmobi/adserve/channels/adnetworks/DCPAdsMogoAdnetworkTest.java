...
public class DCPAdsMogoAdnetworkTest extends TestCase {
  ...
  public void testDCPadsmogoConfigureParametersAndroid() throws JSONException {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(adsmogoAdvId, null, null, null, 0, null,
            ...
            32, new Integer[] {0}));
    assertEquals(true,
        dcpadsmogoAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, clurl, null));
  }
  ...
  public void testDCPadsmogoRequestUriWithNoCat() throws Exception {
    ...
    final ChannelSegmentEntity entity =
        new ChannelSegmentEntity(AdNetworksTest.getChannelSegmentEntityBuilder(adsmogoAdvId, null, null, null, 0, null,
            ...
            false, false, false, false, false, false, false, false, null, new ArrayList<Integer>(), 0.0d, null, null,
            0, new Integer[] {0}));
    if (dcpadsmogoAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, null)) {
      final String actualUrl = dcpadsmogoAdNetwork.getRequestUri().toString();
      final String expectedUrl =
  ...
  public void testDCPadsmogoParseAd() throws Exception {
    ...
    dcpadsmogoAdNetwork.configureParameters(sasParams, casInternalRequestParameters, entity, null, beaconUrl);
