...
public class DCPxAdAdNetwork extends AbstractDCPAdNetworkImpl {
  ...
  public boolean configureParameters() {
    ...
    sourceType = StringUtils.isBlank(sasParams.getSource()) || WAP.equalsIgnoreCase(sasParams.getSource()) ? WEB : APP;
  ...
  public URI getRequestUri() throws Exception {
    try {
      ...
      final String appId = String.format(APP_ID_FORMAT, blindedSiteId, categories.split(",")[0].replace(' ', '_'));
