...
public class DCPVerveAdNetwork extends AbstractDCPAdNetworkImpl {
  ...
  public boolean configureParameters() {
    ...
    try {
      ...
      LOG.info("trueLatLong is not configured for the segment:{} {}, exception raised {}", entity.getExternalSiteKey(),
          getName(), e);
    }
    ...
    if (WAP.equalsIgnoreCase(sasParams.getSource())) {
      ...
      if (StringUtils.isBlank(sasParams.getSdkVersion()) || sasParams.getSdkVersion().toLowerCase().startsWith("a35")) {
