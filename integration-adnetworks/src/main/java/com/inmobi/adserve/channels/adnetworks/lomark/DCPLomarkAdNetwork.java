  ...
  public void parseResponse(final String response, final HttpResponseStatus status) {
    ...
    if (status.code() != 200 || StringUtils.isBlank(response)) {
      ...
      try {
        ...
        final JSONObject adResponse = jsonObject.getJSONObject("data").getJSONObject("ad").getJSONObject("creative");
        ...
        final JSONArray clickBeacons = trackUrlInfo.getJSONArray("clicks").getJSONObject(0).getJSONArray("urls");
        ...
        TemplateType type;
        if (creativeType == 2) {
          context.put(VelocityTemplateFieldConstants.AD_TEXT, displayInfo.getJSONObject("title").getString("text"));
