...
public class Test {
  ...
  private static App getSampleApp(final Injector injector) {

    final GsonManager gsonManager = injector.getInstance(GsonManager.class);

    final App app =
        gsonManager
            .createGson()
            .fromJson(
                "{\"clickurl\":[\"http://adtrack.king.com/modules/adTracking/adClicked.jsp?type=ad&androidId=$O1&st1=inmobi&st2=petrescuesaga&st3=us&st5=interstitial&st4=Native&st6=$IMP_ID&linkId=2302Native\" ],"
                    ...
                    + "\"w\":\"1200\"}," + "\"title\":\"AppLovin\"}", App.class);
  ...
  public static String getContent() {
    final File testFile = new File("/Users/prabhat.kumar/Documents/workspace/parser/templates/native_tango.vm");
  ...
  public static void main(final String args[]) throws ResourceNotFoundException, ParseErrorException, Exception {
    ...
    final TemplateParser parser = injector.getInstance(TemplateParser.class);
